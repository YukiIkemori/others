...
//   west, north row : 宿屋「木漏れ日亭」 · 酒場「切り株亭」, the plaza with the well below them
//   west, middle row: 道具屋 · 武器と防具の店 · the vegetable garden
//   west, south row : ダンの家 · 木こり小屋 · the woodshed, the gate
//   east bank       : the song stone (千年樹の歌の碑) · 長老ハンナの家 · the grove
...
(function (R) {
  ...
  const def = {
    ...
    npcs: [
      ...
      K.npc('st_rival', 'rowell', INN.x, INN.y + 2, { dir: 'up', cond: 'st_show_rival', fixed: true }),
      K.npc('st_fine', 'fine', INN.x + 2, INN.y + 2, { dir: 'up', cond: 'st_show_fine', fixed: true }),
      K.npc('st_extra', 'scribe', INN.x - 2, INN.y + 2, { dir: 'up', cond: 'st_show_extra', fixed: true }),
      ...
      K.talk('herbalist', 'old_man', 31, 16, [
