...
(function (R) {
  ...
  const def = {
    ...
    rows: [
      ...
      '~~~~~~~~~...############..##############..,,,,,,,~~~~~~~',
      '~~~~~~~~~...############..##############..RRRRRR,~~~~~~~',
      '~~~______...#b_b_____uu#..#____________#..RRRRRR,~~~~~~~',
    ...
    npcs: [
      ...
      K.npc('regnas_ship', 'obj:r5_regnas_ship', 4, 36, { dir: 'left', cond: REG, fixed: true,
        text: 'レグナスの商船だ。\n東の大陸から来たらしい。\n見なれない紋章の帆が\n風をはらんでいる。' }),
      ...
      // --- the tavern 「かもめ亭」 (オーナー指示 A17: the aisle in front of the counter is open — the master is talked to
      // from the front across the counter at (29,8); the left tables moved so the whole room can be walked)
      ...
      K.folk('tavern_sailor', 'sailor', 27, 10, [
      ...
      K.npc('st_rival', 'rowell', 17, 15, { dir: 'up', cond: 'st_show_rival', fixed: true, text: '……。' }),
      K.npc('st_fine', 'fine', 19, 15, { dir: 'up', cond: 'st_show_fine', fixed: true, text: '……。' }),
      K.npc('st_extra', 'scribe', 15, 15, { dir: 'up', cond: 'st_show_extra', fixed: true, text: '……。' }),
    ],
    signs: [
