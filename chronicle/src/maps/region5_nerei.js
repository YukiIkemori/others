...
//
// Layout (54×36): the road from Coral comes in on the west (spawn `entrance`, exit → world `nerei`);
...
(function (R) {
  ...
  const def = {
    ...
    rows: [
      ...
      ',,########,,::,#######::,,,,,,,,,,,,dd~~~~_~~~~~~~~~~~',
      ',,########,,::,#######::,,,,,,,,,,,,dd~~~~~~~~~~~~~~~~',
      ',,#b_b___#,,::,#b____#::,,FFFFFF,,,,dd~~~~~~~~~~~~~~~~',
      ',,#______#,,::,#_____#::,,FffzzF,,,,dddd~~~~~~~~~~~~~~',
      ',,#______#,,::,#_____#::,,FzzfzF,,,,ddrd~~~~~~~~~~~~~~',
      ',,#______#,,::,#_____#::,,FzzzzF,,,,dddd~~~~~~~~~~~~~~',
      ',,#______#,,::,#_____#::,,FF::FF,,,,ddrd~~~~~~~~~~~~~~',
      ',,#______#,,::,#_____#::,,,,,,,,,,,,dddd~~~~~~~~~~~~~~',
      ',,####D###,,::,###D###::,,,,,,,,,,,,dddd~~~~~~~~~~~~~~',
      ',,,:::::::::::::::::::::,,,,,,,,,ddmddrd~~~~~~~~~~~~~~',
      ',,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,ddddddd~~~~~~~~~~~~~~',
    ...
    npcs: [
      ...
      K.npc('marina', 'old_woman', 28, 9, { event: 'nerei_marina', dir: 'down', cond: [{ notItem: 'k_shanty' }, NOT], fixed: true }),
      K.npc('marina_song', 'old_woman', 28, 9, { event: 'nerei_marina_song', dir: 'down', cond: [C.shell, '!isles_ship', NOT], fixed: true }),
      K.npc('marina_wait', 'old_woman', 28, 9, { event: 'nerei_marina', dir: 'down', cond: [C.shell, 'isles_ship', NOT], fixed: true }),
      K.npc('marina_home', 'old_woman', 28, 9, { event: 'nerei_marina_reward', dir: 'down', cond: REG, fixed: true }),
      // --- scene figures on the pier (never present by cond; shown by nerei_marina_song / ghost_ship_3_boss)
      K.npc('marina_pier', 'old_woman', 43, 16, { dir: 'right', cond: SCENE, fixed: true, text: '……。' }),
      K.npc('glen_pier', 'ghost', 44, 16, { dir: 'left', cond: SCENE, fixed: true, text: '……。' }),
      ...
      K.npc('beacon', 'obj:r5_beacon', 36, 28, { fixed: true, text: '古い石の灯台だ。\n小さな火が、静かに燃えている。' }),
      ...
      K.folk('net_mender', 'old_man', 18, 23, [
        { cond: C.post, text: '孫に網の繕い方と、\n舟歌を教えておるんじゃ。\nどっちも、大事なことじゃ。' },
        { cond: REG, text: 'グレンはな、わしの\n兄貴分じゃった。\n……やっと、帰ってきたか。' },
        { text: 'グレンが帰らなかった嵐の\n夜のことは、よく覚えとる。\nじゃが、あいつの舟歌が、\nどうしても出てこんのじゃ。' },
      ], { dir: 'right' }),
      K.folk('shed_girl', 'girl', 18, 25, [
      ...
      K.folk('cat', 'cat', 34, 22, 'ニャー。', { move: 'wander' }),
      K.folk('chicken', 'chicken', 28, 23, 'コッコッ。', { move: 'wander' }),
      K.folk('chicken_2', 'chicken', 11, 22, 'コケーッ！', { move: 'wander' }),
    ],
    signs: [
      K.sign(1, 14, '岬の村ネレイ\n東の岬に、桟橋があります。'),
