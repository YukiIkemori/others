...
(function (R) {
  ...
  const def = {
    ...
    npcs: [
      ...
      K.npc('marina_pier', 'old_woman', 40, 17, { dir: 'right', cond: SCENE, fixed: true, text: '……。' }),
      K.npc('glen_pier', 'ghost', 42, 17, { dir: 'left', cond: SCENE, fixed: true, text: '……。' }),
