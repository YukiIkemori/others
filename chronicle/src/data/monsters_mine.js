...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    golem_1: {
      ...
      flags: [], s: { hp: 1.43, atk: 1.03, def: 1.3, agi: 0.65, mag: 0.99 }, eva: 5,
    ...
    golem_2: {
      ...
      flags: [], s: { hp: 1.65, atk: 0.6, def: 1.4, agi: 0.6, mag: 0.54 }, eva: 5,
    ...
    golem_3: {
      ...
      flags: [], s: { hp: 1.93, atk: 0.43, mag: 0.45, def: 1.35, agi: 0.6 }, eva: 5,
      elem: { water: 1.25, wind: 1.5, earth: 0.25 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    mole_1: {
      ...
      flags: [], s: { hp: 1.21, atk: 1.29, agi: 0.9, mag: 1.23 }, eva: 5,
    ...
    mole_2: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.03, agi: 0.9, mag: 0.9 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: {}, statusRes: {},
    ...
    mole_3: {
      ...
      flags: [], s: { hp: 1.32, atk: 0.89, agi: 0.95, mag: 0.81 }, eva: 5,
    ...
    mole_4: {
      ...
      flags: [], s: { hp: 1.79, atk: 0.77, def: 1.1, agi: 0.85, mag: 0.67 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: {}, statusRes: {},
    ...
    beetle_1: {
      ...
      flags: [], s: { def: 1.4, agi: 0.8, hp: 1.1, atk: 0.99, mag: 0.99 }, eva: 5,
    ...
    beetle_2: {
      ...
      flags: [], s: { def: 1.6, agi: 0.8, hp: 1.18, atk: 0.9, mag: 0.9 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: { slash: 0.75, blunt: 1.25 }, statusRes: { poison: 0.5 },
    ...
    beetle_3: {
      ...
      flags: [], s: { mag: 0.93, def: 1.4, agi: 0.85, hp: 1.26, atk: 0.81 }, eva: 5,
    ...
    beetle_4: {
      ...
      flags: [], s: { hp: 1.52, def: 1.8, agi: 0.8, atk: 0.67, mag: 0.67 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: { slash: 0.75, blunt: 1.25 }, statusRes: { poison: 0.5 },
    ...
    crystal_1: {
      ...
      flags: [], s: { hp: 0.99, mag: 1.18, def: 1.2, atk: 0.99 }, eva: 5,
    ...
    crystal_2: {
      ...
      flags: [], s: { hp: 1.06, mag: 1.12, def: 1.2, atk: 0.9 }, eva: 5,
    ...
    crystal_3: {
      ...
      flags: [], s: { hp: 1.2, mag: 0.43, def: 1.2, atk: 0.4 }, eva: 5,
    ...
    crystal_4: {
      ...
      flags: [], s: { mag: 0.87, def: 1.2, mdef: 1.2, hp: 1.38, atk: 0.67 }, eva: 5,
    ...
    goblin_1: {
      ...
      flags: [], s: { atk: 1.36, mag: 1.23, hp: 1.1 }, rw: { gold: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    goblin_2: {
      ...
      flags: [], s: { hp: 1.24, atk: 1.03, mag: 0.9 }, rw: { gold: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    goblin_3: {
      ...
      flags: [], s: { hp: 1.2, atk: 0.89, agi: 1.05, mag: 0.81 }, rw: { gold: 1.3 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    goblin_4: {
      ...
      flags: [], s: { hp: 1.61, atk: 0.82, def: 1.1, mag: 0.72 }, rw: { gold: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    goblin_5: {
      ...
      flags: [], s: { hp: 1.92, atk: 0.75, def: 1.1, mag: 0.63 }, rw: { gold: 2 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
