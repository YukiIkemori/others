...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    golem_1: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.05, def: 1.3, agi: 0.65 }, eva: 5,
    ...
    golem_2: {
      ...
      flags: [], s: { hp: 1.35, atk: 0.71, def: 1.4, agi: 0.6, mag: 0.64 }, eva: 5,
    ...
    golem_3: {
      ...
      flags: [], s: { hp: 1.4, atk: 0.64, mag: 0.67, def: 1.35, agi: 0.6 }, eva: 5,
      elem: { water: 1.25, wind: 1.5, earth: 0.25 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    mole_1: {
      ...
      flags: [], s: { hp: 1.1, atk: 1.31, agi: 0.9, mag: 1.25 }, eva: 5,
    ...
    mole_2: {
      ...
      flags: [], s: { hp: 1.1, atk: 1.15, agi: 0.9 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: {}, statusRes: {},
    ...
    mole_3: {
      ...
      flags: [], s: { hp: 1.05, atk: 1.1, agi: 0.95 }, eva: 5,
    ...
    mole_4: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.15, def: 1.1, agi: 0.85 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: {}, statusRes: {},
    ...
    beetle_3: {
      ...
      flags: [], s: { mag: 1.15, def: 1.4, agi: 0.85 }, eva: 5,
    ...
    beetle_4: {
      ...
      flags: [], s: { hp: 1.1, def: 1.8, agi: 0.8 }, eva: 5,
      elem: { fire: 1.25, wind: 1.5, earth: 0.25 }, phys: { slash: 0.75, blunt: 1.25 }, statusRes: { poison: 0.5 },
    ...
    crystal_1: {
      ...
      flags: [], s: { hp: 0.9, mag: 1.2, def: 1.2 }, eva: 5,
    ...
    crystal_2: {
      ...
      flags: [], s: { hp: 0.9, mag: 1.25, def: 1.2 }, eva: 5,
    ...
    crystal_3: {
      ...
      flags: [], s: { hp: 0.95, mag: 0.53, def: 1.2, atk: 0.5 }, eva: 5,
    ...
    crystal_4: {
      ...
      flags: [], s: { mag: 1.3, def: 1.2, mdef: 1.2 }, eva: 5,
    ...
    goblin_1: {
      ...
      flags: [], s: { atk: 1.38, mag: 1.25 }, rw: { gold: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    goblin_2: {
      ...
      flags: [], s: { hp: 1.05, atk: 1.15 }, rw: { gold: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    goblin_3: {
      ...
      flags: [], s: { hp: 0.95, atk: 1.1, agi: 1.05 }, rw: { gold: 1.3 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    goblin_4: {
      ...
      flags: [], s: { hp: 1.2, atk: 1.15, def: 1.1 }, rw: { gold: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    goblin_5: {
      ...
      flags: [], s: { hp: 1.35, atk: 1.2, def: 1.1 }, rw: { gold: 2 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
