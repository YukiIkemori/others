...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    jelly_1: {
      ...
      flags: [], s: { hp: 1.21, atk: 1.11, agi: 0.8, mag: 1.23 }, eva: 5,
    ...
    jelly_2: {
      ...
      flags: [], s: { hp: 1.24, mag: 0.98, agi: 0.9, atk: 0.9 }, eva: 5,
    ...
    jelly_3: {
      ...
      flags: [], s: { hp: 1.39, atk: 0.81, mag: 0.81 }, eva: 5,
    ...
    jelly_4: {
      ...
      flags: [], s: { hp: 1.74, atk: 0.79, def: 1.1, mag: 0.72 }, eva: 5,
      elem: { fire: 1.25 }, phys: { slash: 1.25, blunt: 0.5 }, statusRes: {},
    ...
    jelly_5: {
      ...
      flags: [], s: { hp: 1.7, mag: 0.75, mdef: 1.2, atk: 0.63 }, eva: 5,
    ...
    rat_1: {
      ...
      flags: [], s: { hp: 0.99, agi: 1.2, atk: 0.99, mag: 0.99 }, eva: 5,
    ...
    rat_2: {
      ...
      flags: [], s: { hp: 1.06, atk: 0.94, agi: 1.2, mag: 0.9 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    rat_3: {
      ...
      flags: [], s: { atk: 0.89, def: 1.25, hp: 1.26, mag: 0.81 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    rat_4: {
      ...
      flags: [], s: { hp: 1.66, atk: 0.74, mag: 0.67 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    bat_1: {
      ...
      flags: ['flying'], s: { hp: 0.94, agi: 1.4, atk: 0.99, mag: 0.99 }, eva: 15,
    ...
    bat_2: {
      ...
      flags: ['flying'], s: { hp: 1.06, agi: 1.35, atk: 0.9, mag: 0.9 }, eva: 15,
      elem: { fire: 1.25, wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    bat_3: {
      ...
      flags: ['flying'], s: { hp: 1.13, mag: 0.49, agi: 1.3, atk: 0.45 }, eva: 15,
      elem: { fire: 1.25, wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    bat_4: {
      ...
      flags: ['flying'], s: { hp: 1.27, mag: 0.82, agi: 1.35, atk: 0.72 }, eva: 15,
    ...
    bat_5: {
      ...
      flags: ['flying'], s: { hp: 1.85, mag: 0.53, agi: 1.25, atk: 0.44 }, eva: 12,
      elem: { fire: 1.25, wind: 1.5, earth: 0.5, light: 1.5, dark: 0.25 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    paper_1: {
      ...
      flags: [], s: { hp: 1.06, mag: 1.24, agi: 1.1, atk: 1.12 }, eva: 5,
    ...
    paper_2: {
      ...
      flags: [], s: { atk: 0.85, agi: 1.1, hp: 1.26, mag: 0.81 }, eva: 5,
      elem: { fire: 1.5, light: 0.25, dark: 1.5 }, phys: { slash: 1.25, blunt: 0.75 }, statusRes: { poison: 1, death: 1, confuse: 0.5, sleep: 0.5 },
    ...
    paper_3: {
      ...
      flags: [], s: { hp: 1.61, atk: 0.79, def: 1.2, agi: 0.85, mag: 0.72 }, eva: 5,
      elem: { fire: 1.5, light: 0.25, dark: 1.5 }, phys: { slash: 1.25, blunt: 0.75 }, statusRes: { poison: 1, death: 1, confuse: 0.5, sleep: 0.5 },
    ...
    paper_4: {
      ...
      flags: ['flying'], s: { hp: 1.56, atk: 0.69, mag: 0.69 }, eva: 12,
    ...
    crab_1: {
      ...
      flags: [], s: { hp: 1.05, def: 1.4, agi: 0.8, atk: 1.23, mag: 1.23 }, eva: 5,
    ...
    crab_2: {
      ...
      flags: [], s: { def: 1.7, mdef: 0.8, agi: 0.7, hp: 1.18, atk: 0.9, mag: 0.9 }, eva: 5,
    ...
    crab_3: {
      ...
      flags: [], s: { mag: 0.89, def: 1.4, hp: 1.26, atk: 0.81 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    crab_4: {
      ...
      flags: [], s: { hp: 1.93, def: 1.6, agi: 0.6, atk: 0.67, mag: 0.67 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    seabird_1: {
      ...
      flags: ['flying'], s: { hp: 0.99, agi: 1.3, atk: 1.23, mag: 1.23 }, eva: 15,
    ...
    seabird_2: {
      ...
      flags: ['flying'], s: { hp: 1.12, mag: 0.98, agi: 1.3, atk: 0.9 }, eva: 15,
    ...
    seabird_3: {
      ...
      flags: ['flying'], s: { hp: 1.13, atk: 0.85, agi: 1.35, mag: 0.81 }, rw: { gold: 2 }, eva: 15,
      elem: { wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    seabird_4: {
      ...
      flags: ['flying'], s: { hp: 1.66, mag: 0.77, agi: 1.2, atk: 0.67 }, eva: 12,
      elem: { fire: 1.5, wind: 0.25, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    mimic_1: {
      ...
      flags: [], s: { hp: 1.32, atk: 1.13, def: 1.2, agi: 0.9, mag: 0.99 }, rw: { gold: 3 }, eva: 5,
    ...
    mimic_2: {
      ...
      flags: [], s: { hp: 1.42, atk: 1.03, def: 1.2, agi: 0.9, mag: 0.9 }, rw: { gold: 3 }, eva: 5,
      elem: { water: 1.25, wind: 0.75 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    mimic_3: {
      ...
      flags: [], s: { hp: 1.58, atk: 0.97, def: 1.2, agi: 0.9, mag: 0.81 }, rw: { gold: 3 }, eva: 5,
      elem: { water: 1.25, wind: 0.75 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    mimic_4: {
      ...
      flags: [], s: { hp: 1.79, atk: 0.8, mag: 0.77, def: 1.25, agi: 0.9 }, rw: { gold: 3 }, eva: 5,
