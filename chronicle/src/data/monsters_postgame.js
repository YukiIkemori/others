...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    void_1: {
      ...
      flags: [], s: { hp: 2.18, atk: 0.5, mag: 0.5 }, eva: 5,
    ...
    void_3: {
      ...
      flags: [], s: { hp: 2.05, atk: 0.5, mag: 0.5 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.75, blunt: 0.75, pierce: 0.75 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    chaos_1: {
      ...
      flags: [], s: { hp: 2.13, atk: 0.5, agi: 0.9, mag: 0.5 }, eva: 5,
    ...
    chaos_2: {
      ...
      flags: [], s: { hp: 2.17, atk: 0.5, mag: 0.5, agi: 0.9 }, eva: 5,
      elem: { fire: 1.25, light: 1.5, dark: 0.25 }, phys: {}, statusRes: {},
    ...
    chaos_3: {
      ...
      flags: [], s: { hp: 2.11, atk: 0.5, mag: 0.5, agi: 0.9 }, eva: 5,
      elem: { fire: 1.25, light: 1.5, dark: 0.25 }, phys: {}, statusRes: {},
