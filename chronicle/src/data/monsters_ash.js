...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    salamander_1: {
      ...
      flags: [], s: { agi: 1.05, hp: 1.38, mag: 0.99, atk: 1.05 }, eva: 5,
    ...
    salamander_2: {
      ...
      flags: [], s: { atk: 0.42, mag: 0.42, hp: 1.74 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    salamander_3: {
      ...
      flags: [], s: { hp: 1.87, atk: 0.85, def: 1.15, mag: 0.73 }, eva: 5,
    ...
    salamander_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.34, mag: 0.34 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    imp_1: {
      ...
      flags: [], s: { hp: 1.36, atk: 0.69, agi: 1.2, mag: 0.66 }, eva: 5,
    ...
    imp_2: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.42, agi: 1.2, atk: 0.42 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    imp_3: {
      ...
      flags: [], s: { hp: 2.33, mag: 0.39, agi: 1.2, atk: 0.39 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    imp_4: {
      ...
      flags: [], s: { mag: 0.39, agi: 1.2, hp: 2.5, atk: 0.39 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    imp_5: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.93, mdef: 1.25, agi: 1.15, atk: 0.71 }, eva: 5,
    ...
    gargoyle_2: {
      ...
      flags: ['flying'], s: { hp: 1.28, def: 1.35, mag: 0.88, atk: 0.94 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5, light: 1.5, dark: 0.5 }, phys: { slash: 0.75, blunt: 1.25, pierce: 0.75 }, statusRes: { death: 0.8 },
    ...
    gargoyle_3: {
      ...
      flags: ['flying'], s: { hp: 1.64, atk: 0.41, mag: 0.41, def: 1.3 }, eva: 12,
    ...
    gargoyle_4: {
      ...
      flags: ['flying'], s: { hp: 1.69, atk: 1.15, def: 1.35 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5, light: 1.5, dark: 0.5 }, phys: { slash: 0.75, blunt: 1.25, pierce: 0.75 }, statusRes: { death: 0.8 },
    ...
    orc_2: {
      ...
      flags: [], s: { hp: 1.36, atk: 0.88, mdef: 0.85, agi: 0.8, mag: 0.69 }, rw: { gold: 1.3 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    orc_3: {
      ...
      flags: [], s: { hp: 1.79, atk: 0.78, def: 1.05, agi: 0.8, mag: 0.61 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    chimera_1: {
      ...
      flags: [], s: { hp: 1.15, atk: 0.89, mag: 0.81 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    chimera_2: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.51, mag: 0.51 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    chimera_3: {
      ...
      flags: [], s: { hp: 1.76, atk: 0.3, mag: 0.3 }, eva: 5,
      elem: { fire: -1, water: 1.5 }, phys: {}, statusRes: {},
