...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    salamander_1: {
      ...
      flags: [], s: { atk: 0.91, agi: 1.05, hp: 1.41, mag: 0.86 }, eva: 5,
    ...
    salamander_2: {
      ...
      flags: [], s: { atk: 0.5, mag: 0.5, hp: 1.88 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    salamander_3: {
      ...
      flags: [], s: { hp: 1.66, atk: 0.69, def: 1.15, mag: 0.62 }, eva: 5,
    ...
    salamander_4: {
      ...
      flags: [], s: { hp: 2.42, atk: 0.5, mag: 0.5 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    salamander_5: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.5, mag: 0.5 }, eva: 5,
      elem: { fire: -1, water: 1.5 }, phys: {}, statusRes: {},
    ...
    imp_1: {
      ...
      flags: [], s: { hp: 1.61, atk: 0.58, agi: 1.2, mag: 0.54 }, eva: 5,
    ...
    imp_2: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.5, agi: 1.2, atk: 0.5 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    imp_3: {
      ...
      flags: [], s: { hp: 2.32, mag: 0.5, agi: 1.2, atk: 0.5 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    imp_4: {
      ...
      flags: [], s: { mag: 0.5, agi: 1.2, hp: 2.5, atk: 0.5 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    imp_5: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.85, mdef: 1.25, agi: 1.15, atk: 0.65 }, eva: 5,
    ...
    gargoyle_1: {
      ...
      flags: ['flying'], s: { hp: 0.9, def: 1.3, agi: 0.95, atk: 1.08, mag: 1.08 }, eva: 12,
    ...
    gargoyle_2: {
      ...
      flags: ['flying'], s: { hp: 1.3, def: 1.35, mag: 0.64, atk: 0.7 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5, light: 1.5, dark: 0.5 }, phys: { slash: 0.75, blunt: 1.25, pierce: 0.75 }, statusRes: { death: 0.8 },
    ...
    gargoyle_3: {
      ...
      flags: ['flying'], s: { hp: 1.64, atk: 0.5, mag: 0.5, def: 1.3 }, eva: 12,
    ...
    gargoyle_4: {
      ...
      flags: ['flying'], s: { hp: 1.81, atk: 1.24, def: 1.35, mag: 1.09 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5, light: 1.5, dark: 0.5 }, phys: { slash: 0.75, blunt: 1.25, pierce: 0.75 }, statusRes: { death: 0.8 },
    ...
    orc_1: {
      ...
      flags: [], s: { hp: 1.21, atk: 1.3, def: 0.95, mdef: 0.85, agi: 0.8, mag: 1.09 }, rw: { gold: 1.3 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    orc_2: {
      ...
      flags: [], s: { hp: 1.33, atk: 0.8, mdef: 0.85, agi: 0.8, mag: 0.63 }, rw: { gold: 1.3 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    orc_3: {
      ...
      flags: [], s: { hp: 1.89, atk: 0.73, def: 1.05, agi: 0.8, mag: 0.57 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    chimera_1: {
      ...
      flags: [], s: { hp: 1.09, atk: 0.81, mag: 0.74 }, eva: 5,
      elem: { fire: 0.25, water: 1.5 }, phys: {}, statusRes: {},
    ...
    chimera_3: {
      ...
      flags: [], s: { hp: 2, atk: 0.5, mag: 0.5 }, eva: 5,
      elem: { fire: -1, water: 1.5 }, phys: {}, statusRes: {},
