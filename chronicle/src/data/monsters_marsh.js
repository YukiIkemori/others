...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    ghost_1: {
      ...
      flags: [], s: { hp: 0.68, mag: 1.05, mdef: 1.2, atk: 0.95 }, eva: 5,
    ...
    ghost_2: {
      ...
      flags: [], s: { hp: 0.71, mag: 1.14, mdef: 1.2 }, eva: 5,
      elem: { light: 1.5 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    ghost_3: {
      ...
      flags: [], s: { mag: 1.01, mdef: 1.2, hp: 1.16, atk: 0.85 }, eva: 5,
    ...
    ghost_4: {
      ...
      flags: [], s: { hp: 1.39, mag: 0.5, mdef: 1.2, atk: 0.5 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    ghost_5: {
      ...
      flags: [], s: { hp: 1.14, mag: 0.61, mdef: 1.25, atk: 0.5 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    wisp_1: {
      ...
      flags: [], s: { hp: 0.92, mag: 0.53, agi: 1.2, atk: 0.5 }, eva: 5,
    ...
    wisp_2: {
      ...
      flags: [], s: { hp: 0.91, mag: 0.5, agi: 1.2, atk: 0.5 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    wisp_3: {
      ...
      flags: [], s: { hp: 1.93, mag: 0.59, agi: 1.2, atk: 0.5 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    wisp_4: {
      ...
      flags: [], s: { hp: 2.13, mag: 0.5, agi: 1.2, atk: 0.5 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    frog_1: {
      ...
      flags: [], s: { hp: 1.65, atk: 0.94, mag: 0.94 }, eva: 5,
    ...
    frog_2: {
      ...
      flags: [], s: { hp: 2.32, atk: 0.65, agi: 1.05, mag: 0.62 }, eva: 5,
    ...
    frog_3: {
      ...
      flags: [], s: { hp: 2.17, atk: 0.81, agi: 0.85, mag: 0.71 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    frog_4: {
      ...
      flags: [], s: { hp: 2.27, mag: 0.5, agi: 0.9, atk: 0.5 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    doll_1: {
      ...
      flags: [], s: { def: 1.1, atk: 1.12, mag: 1.12, hp: 0.98 }, eva: 5,
    ...
    doll_2: {
      ...
      flags: [], s: { agi: 1.2, atk: 0.57, mag: 0.57 }, eva: 5,
      elem: { water: 1.25, wind: 0.75 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    doll_3: {
      ...
      flags: [], s: { hp: 1.52, mag: 0.95, mdef: 1.1, atk: 0.8 }, eva: 5,
    ...
    doll_4: {
      ...
      flags: [], s: { hp: 1.4, mag: 1.13, mdef: 1.2, agi: 1.05, atk: 0.91 }, eva: 5,
    ...
    lizardman_1: {
      ...
      flags: [], s: { hp: 1.24, mag: 0.86, atk: 0.91 }, eva: 5,
    ...
    lizardman_2: {
      ...
      flags: [], s: { hp: 1.5, atk: 0.72, mag: 0.64 }, eva: 5,
      elem: { water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    lizardman_3: {
      ...
      flags: [], s: { hp: 1.7, atk: 0.56, mag: 0.89, mdef: 1.2 }, eva: 5,
      elem: { water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    lizardman_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.54, def: 1.1, mag: 0.5 }, eva: 5,
      elem: { water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    spider_1: {
      ...
      flags: [], s: { agi: 1.1, hp: 1.32, atk: 1.2, mag: 1.2 }, eva: 5,
    ...
    spider_2: {
      ...
      flags: [], s: { atk: 0.75, agi: 1.1, hp: 1.75, mag: 0.72 }, eva: 5,
    ...
    spider_3: {
      ...
      flags: [], s: { atk: 0.96, agi: 1.2, hp: 1.68, mag: 0.87 }, eva: 5,
    ...
    spider_4: {
      ...
      flags: [], s: { hp: 1.53, atk: 1.01, mag: 1.01, agi: 1.1 }, eva: 5,
      elem: { fire: 1.5 }, phys: {}, statusRes: { poison: 0.5 },
