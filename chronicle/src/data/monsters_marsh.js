...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    ghost_1: {
      ...
      flags: [], s: { hp: 0.68, mag: 1.08, mdef: 1.2, atk: 0.99 }, eva: 5,
    ...
    ghost_2: {
      ...
      flags: [], s: { hp: 0.64, mag: 1.15, mdef: 1.2 }, eva: 5,
      elem: { light: 1.5 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    ghost_4: {
      ...
      flags: [], s: { hp: 1.05, mag: 0.58, mdef: 1.2, atk: 0.58 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    ghost_5: {
      ...
      flags: [], s: { hp: 1.17, mag: 0.61, mdef: 1.25, atk: 0.5 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    wisp_1: {
      ...
      flags: [], s: { hp: 0.9, mag: 0.59, agi: 1.2, atk: 0.56 }, eva: 5,
    ...
    wisp_2: {
      ...
      flags: [], s: { hp: 0.94, mag: 0.4, agi: 1.2, atk: 0.4 }, eva: 5,
      elem: { fire: 0.25, water: 1.5, light: 1.5 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    wisp_3: {
      ...
      flags: [], s: { hp: 1.95, mag: 0.61, agi: 1.2, atk: 0.55 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    wisp_4: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.3, agi: 1.2, atk: 0.3 }, eva: 5,
      elem: { light: 1.5, dark: 0.25 }, phys: { slash: 0.5, blunt: 0.5, pierce: 0.5 }, statusRes: { poison: 1, death: 1, stun: 1 },
    ...
    frog_2: {
      ...
      flags: [], s: { hp: 2.27, atk: 0.79, agi: 1.05, mag: 0.75 }, eva: 5,
    ...
    frog_3: {
      ...
      flags: [], s: { hp: 2.22, atk: 0.87, agi: 0.85, mag: 0.75 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    frog_4: {
      ...
      flags: [], s: { hp: 2.29, mag: 0.48, agi: 0.9, atk: 0.48 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    doll_2: {
      ...
      flags: [], s: { agi: 1.2, atk: 0.75, mag: 0.75 }, eva: 5,
      elem: { water: 1.25, wind: 0.75 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    doll_3: {
      ...
      flags: [], s: { hp: 1.49, mag: 1.17, mdef: 1.1, atk: 0.99 }, eva: 5,
    ...
    doll_4: {
      ...
      flags: [], s: { hp: 1.57, mag: 1.17, mdef: 1.2, agi: 1.05, atk: 0.93 }, eva: 5,
    ...
    lizardman_1: {
      ...
      flags: [], s: { hp: 1.05, mag: 0.94 }, eva: 5,
    ...
    lizardman_2: {
      ...
      flags: [], s: { hp: 1.74, atk: 0.82, mag: 0.73 }, eva: 5,
      elem: { water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    lizardman_3: {
      ...
      flags: [], s: { hp: 1.77, atk: 0.57, mag: 0.92, mdef: 1.2 }, eva: 5,
      elem: { water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    spider_2: {
      ...
      flags: [], s: { atk: 0.83, agi: 1.1, hp: 1.74, mag: 0.78 }, eva: 5,
    ...
    spider_3: {
      ...
      flags: [], s: { atk: 1.01, agi: 1.2, hp: 1.85, mag: 0.92 }, eva: 5,
    ...
    spider_4: {
      ...
      flags: [], s: { hp: 1.56, agi: 1.1, atk: 1.1, mag: 1.1 }, eva: 5,
      elem: { fire: 1.5 }, phys: {}, statusRes: { poison: 0.5 },
