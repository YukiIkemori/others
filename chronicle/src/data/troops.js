...
(function (R) {
  ...
  Object.assign(R.DB.troops, {
    ...
    tr_b_rooteater: boss([['b_root', 1], ['b_rooteater', 1], ['b_root', 1]], { scale: 'tier', lvOff: 2, bg: 'tree', bgm: 'boss2' }),
    tr_b_sandworm: boss([['b_sandworm', 1]], { scale: 'tier', lvOff: 3, bg: 'pyramid', bgm: 'boss' }),
    tr_b_sandking: boss([['@mummy', 1], ['b_sandking', 1], ['@mummy', 1]], { scale: 'tier', lvOff: 1, bg: 'pyramid', bgm: 'boss2' }),
    tr_b_icegiant: boss([['b_icegiant', 1]], { scale: 'tier', lvOff: 3, bg: 'ice', bgm: 'boss' }),
    tr_b_whitedragon: boss([['b_whitedragon', 1]], { scale: 'tier', lvOff: 1, bg: 'peak', bgm: 'boss2' }),
    tr_b_dolls: boss([['b_doll_violin', 1], ['b_doll_conductor', 1], ['b_doll_drum', 1], ['b_doll_flute', 1]],
      { scale: 'tier', lvOff: 3, bg: 'manor', bgm: 'boss' }),
    ...
    tr_b_ironwarden: boss([['b_ironwarden', 1]], { scale: 'tier', lvOff: 6, bg: 'mine', bgm: 'boss2' }),
    tr_b_hellhound: boss([['b_hellhound', 1]], { scale: 'tier', lvOff: 3, bg: 'volcano', bgm: 'boss' }),
    tr_b_lavabeast: boss([['b_lavabeast', 1]], { scale: 'tier', lvOff: 3, bg: 'volcano', bgm: 'boss2' }),
    tr_b_orrery: boss([['b_orrery', 1]], { scale: 'tier', lvOff: 5, bg: 'tower', bgm: 'boss' }),
