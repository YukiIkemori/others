...
(function (R) {
  ...
  const ITEMS = {
    ...
    ac_rl_moon: { name: 'オーロラの羽飾り', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_aurora_bird',
      mods: { intPct: 10, mpRegen: 1 },
      price: 1500,
      desc: '知力が割合で上がる。\n戦闘中、MPが少しずつ戻る。' },
    ...
    ac_rl_sun: { name: 'はすの花飾り', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_lotus_sprite',
      mods: { mndPct: 10, healPct: 35 },
      price: 1500,
    ...
    ac_rl_star: { name: '歯車の羽根', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_clock_bird',
      mods: { dexPct: 10, glimPct: { tech: 15 } },
      price: 1500,
    ...
    ac_rl_wind: { name: 'ガラスの羽', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_glass_moth',
      mods: { agiPct: 10, spd: 15 },
      price: 1500,
    ...
    ac_rl_tide: { name: '幽霊のティーカップ', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_ghost_teapot',
      mods: { vitPct: 10, elemResist: { water: 0.5 } },
      price: 1500,
      desc: '体力が割合で上がる。\n水のダメージを減らす。' },
    ...
    ac_rl_ember: { name: '火山ガメの甲羅片', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_volcano_turtle',
      mods: { strPct: 10, elemBoost: { fire: 20 } },
      price: 1500,
    ...
    ac_rl_frost: { name: '氷尾の毛飾り', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_icetail_fox',
      mods: { intPct: 10, statusImmune: ['freeze'] },
      price: 1500,
    ...
    ac_rl_bloom: { name: '花角の髪飾り', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_bloom_fawn',
    ...
    ac_rl_thorn: { name: '宝石針のブローチ', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_gem_hedgehog',
      mods: { strPct: 10, crit: 10 },
      price: 1500,
    ...
    ac_rl_shadow: { name: '夢見のまくら', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_dream_tapir',
      mods: { agiPct: 10, encounterPct: -50 },
      price: 1500,
      desc: '素早さが割合で上がる。\n魔物に出会いにくい。' },
    // rm_gold_idol（鍵 gold、レア枠 1/6）
    ac_rl_gold: { name: '守護像のひすい', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_gold_idol',
      mods: { goldPct: 20, goldenPct: 20 },
      price: 1500,
      desc: '手に入るお金が増える。\n金色の魔物に出会いやすい。' },
    ...
    ac_rl_clover: { name: '海賊の杯', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_treasure_crab',
      mods: { dexPct: 10, rarePct: 20 },
      price: 1500,
      desc: '器用さが割合で上がる。\nレアの品を落としやすい。' },
    ...
    ac_rl_sage: { name: '本の虫の眼鏡', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_bookworm',
      mods: { intPct: 10, expPct: 15 },
      price: 1500,
      desc: '知力が割合で上がる。経験値が増える。' },
    // rm_diamond_lizard（鍵 iron、レア枠 1/6）
    ac_rl_iron: { name: '金剛トカゲのうろこ', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_diamond_lizard',
      mods: { vitPct: 10, statusImmune: ['stun'] },
      price: 1500,
    ...
    ac_rl_spirit: { name: '金魚のうろこ', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_memory_fish',
      mods: { mndPct: 10, statusImmune: ['death'] },
      price: 1500,
      desc: '精神が割合で上がる。即死が効かない。' },
    // rm_spa_monkey（鍵 beast、レア枠 1/6）
    ac_rl_beast: { name: '湯けむりの手ぬぐい', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_spa_monkey',
      mods: { strPct: 10, physPct: 15 },
      price: 1500,
      desc: '腕力が割合で上がる。\n物理攻撃の威力が上がる。' },
    ...
    ac_rl_bird: { name: '宝石ウサギのお守り', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_jewel_hare',
      mods: { agiPct: 10, escapePct: 50 },
      price: 1500,
    ...
    ac_rl_dream: { name: '月見の鈴', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_moon_sheep',
      mods: { mndPct: 10, statusImmune: ['sleep'] },
      price: 1500,
    ...
    ac_rl_bell: { name: '鐘の殻', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_bell_snail',
      mods: { mndPct: 10, statusResist: { silence: 0.5, confuse: 0.5 } },
      price: 1500,
      desc: '精神が割合で上がる。\n沈黙・混乱にかかりにくい。' },
    ...
    ac_rl_prism: { name: '虹晶の指輪', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_prisma',
      mods: { intPct: 10, magicPct: 15 },
      price: 1500,
    ...
    ac_rl_sea: { name: '星の香玉', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_star_whale',
      mods: { vitPct: 10, hpPct: 10 },
      price: 1500,
    ...
    ac_rl_peak: { name: 'どんぐりの帽子飾り', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_acorn_prince',
      mods: { vitPct: 10, wpRegen: 1 },
      price: 1500,
      desc: '体力が割合で上がる。\n戦闘中、WPが少しずつ戻る。' },
    ...
    ac_rl_tale: { name: '黄金のペン先', type: 'acc', grade: 'rare', tier: 0, src: 'relic', exclusive: 'rm_golden_quill',
      mods: { mndPct: 10, glimPct: { spell: 15 } },
      price: 1500,
