...
(function (R) {
  ...
  const S = {
    ...
    b_hellhound: { hp: 1.35, atk: 0.85, mag: 0.85 },
    b_lavabeast: { hp: 0.9, atk: 0.85, mag: 0.85 },
    b_orrery: { hp: 1.35 },
    b_stareater: { hp: 1.1, atk: 0.7, mag: 0.7 },
    b_rowell1: { hp: 1.1 },
    b_rowell2: { hp: 1.65, atk: 0.85, mag: 0.85 },
    b_bookgolem: { hp: 1.1, atk: 0.85, mag: 0.85 },
    b_shade_sword: { hp: 1.25, atk: 0.7, mag: 0.7 },
    b_shade_prayer: { hp: 1.25, atk: 0.7, mag: 0.7 },
    b_shade_star: { hp: 1.25, atk: 0.7, mag: 0.7 },
    b_lazaro: { hp: 1.35 },
    b_nemrea1: { hp: 0.8 },
