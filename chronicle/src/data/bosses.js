...
(function (R) {
  ...
  const S = {
    b_pageeater: { hp: 1.35 },
    b_moth: { hp: 1.65 },
    b_rooteater: { hp: 1.2, atk: 0.6, mag: 0.6 },
    b_root: { hp: 1.2, atk: 0.6, mag: 0.6 },
    b_sandworm: { hp: 1.5 },
    b_sandking: { hp: 0.9, atk: 0.7, mag: 0.7 },
    b_icegiant: { hp: 1.5 },
    b_whitedragon: { hp: 1.35, atk: 0.6, mag: 0.6 },
    b_doll_conductor: { hp: 1.1 },
    b_doll_violin: { hp: 1.1 },
    b_doll_drum: { hp: 1.1 },
    b_doll_flute: { hp: 1.1 },
    ...
    b_octopus: { hp: 1.5 },
    b_tentacle: { hp: 1.5 },
    b_captain: { hp: 1.2, atk: 0.7, mag: 0.7 },
    b_rockeater: { hp: 1.5 },
    b_ironwarden: { hp: 0.9, atk: 0.7, mag: 0.7 },
    b_hellhound: { hp: 1.5, atk: 0.8, mag: 0.8 },
    b_lavabeast: { hp: 0.9, atk: 0.8, mag: 0.8 },
    b_orrery: { hp: 1.35 },
    b_stareater: { hp: 1.2, atk: 0.5, mag: 0.5 },
    b_rowell1: { hp: 1.2 },
    b_rowell2: { hp: 1.35 },
    b_bookgolem: { hp: 0.9 },
    b_shade_sword: { hp: 1.1, atk: 0.8, mag: 0.8 },
    b_shade_prayer: { hp: 1.1, atk: 0.8, mag: 0.8 },
    b_shade_star: { hp: 1.1, atk: 0.8, mag: 0.8 },
    b_lazaro: { hp: 1.2 },
    b_nemrea1: { hp: 0.7, atk: 0.8, mag: 0.8 },
    b_nemrea2: { hp: 0.5, atk: 0.5, mag: 0.5 },
    b_valzard_echo: { hp: 1.35, atk: 0.7, mag: 0.7 },
    b_ouroboros: { hp: 0.5, atk: 0.55, mag: 0.55 },
  };
  // @@S-END
