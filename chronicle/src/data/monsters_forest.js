...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    bee_1: {
      ...
      flags: ['flying'], s: { hp: 1.27, agi: 1.35, atk: 0.66, mag: 0.66 }, eva: 15,
    ...
    bee_2: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.38, agi: 1.35, mag: 0.38 }, eva: 15,
    ...
    bee_3: {
      ...
      flags: ['flying'], s: { hp: 2.5, agi: 1.35, atk: 0.67, mag: 0.67 }, eva: 15,
      elem: { fire: 1.5, wind: 1.5, earth: 0.5 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    bee_4: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.61, agi: 1.35, mag: 0.61 }, eva: 15,
      elem: { fire: 1.5, wind: 1.5, earth: 0.5 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    bee_5: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.43, mag: 0.43, agi: 1.2 }, eva: 12,
      elem: { fire: 1.5, wind: 1.5, earth: 0.5 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    mushroom_1: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.98, agi: 0.6, mag: 2.21 }, eva: 5,
    ...
    mushroom_2: {
      ...
      flags: [], s: { hp: 2.5, atk: 1.23, agi: 0.6, mag: 1.4 }, eva: 5,
    ...
    mushroom_3: {
      ...
      flags: [], s: { hp: 1.76, agi: 0.7, mag: 1.14, atk: 1.03 }, eva: 5,
      elem: { fire: 1.5, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    mushroom_4: {
      ...
      flags: [], s: { hp: 2.07, mag: 1.2, mdef: 1.2, agi: 0.6 }, eva: 5,
    ...
    plant_1: {
      ...
      flags: [], s: { hp: 1.34, atk: 1.05, agi: 0.8 }, eva: 5,
      elem: { fire: 1.5, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    plant_2: {
      ...
      flags: [], s: { hp: 1.91, atk: 1.09, agi: 0.8, mag: 0.98 }, eva: 5,
      elem: { fire: 1.5, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    plant_3: {
      ...
      flags: [], s: { hp: 2.29, mag: 0.32, agi: 0.8, atk: 0.32 }, eva: 5,
      elem: { fire: 1.5, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    plant_4: {
      ...
      flags: [], s: { hp: 1.26, mag: 1.13, agi: 0.85 }, eva: 5,
    ...
    plant_5: {
      ...
      flags: [], s: { hp: 1.3, mag: 0.76, mdef: 1.2, agi: 0.8, atk: 0.64 }, eva: 5,
    ...
    fairy_1: {
      ...
      flags: ['flying'], s: { hp: 1.54, mag: 0.95, agi: 1.4, atk: 0.88 }, eva: 15,
    ...
    fairy_2: {
      ...
      flags: ['flying'], s: { hp: 2.3, mag: 0.71, mdef: 1.1, agi: 1.3, atk: 0.59 }, eva: 15,
    ...
    fairy_3: {
      ...
      flags: ['flying'], s: { hp: 0.85, mag: 0.85, agi: 1.3, atk: 0.71 }, eva: 15,
    ...
    fairy_4: {
      ...
      flags: ['flying'], s: { mag: 0.3, mdef: 1.2, agi: 1.3, hp: 2.02, atk: 0.3 }, eva: 15,
      elem: { wind: 1.5, earth: 0.5, light: 0.25, dark: 1.5 }, phys: { pierce: 1.25 }, statusRes: { confuse: 0.5 },
    ...
    treant_1: {
      ...
      flags: [], s: { def: 1.2, agi: 0.7, atk: 1.5, mag: 1.5 }, eva: 5,
      elem: { fire: 1.5, water: 0.5, wind: 1.5, earth: 0.25 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    treant_2: {
      ...
      flags: [], s: { hp: 1.16, def: 1.2, agi: 0.7, atk: 1.1 }, eva: 5,
      elem: { fire: 1.5, water: 0.5, wind: 1.5, earth: 0.25 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
