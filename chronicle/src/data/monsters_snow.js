...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    wolf_1: {
      ...
      flags: [], s: { atk: 1.05, agi: 1.15 }, eva: 5,
    ...
    wolf_2: {
      ...
      flags: [], s: { atk: 1.1, agi: 1.15 }, eva: 5,
    ...
    wolf_3: {
      ...
      flags: [], s: { hp: 1.05, atk: 0.73, mag: 0.76, agi: 1.15 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    wolf_4: {
      ...
      flags: [], s: { atk: 1.15, agi: 1.25 }, eva: 5,
    ...
    wolf_5: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.86, agi: 1.2, mag: 0.75 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    yeti_1: {
      ...
      flags: [], s: { hp: 1.2, atk: 1.15, agi: 0.8 }, eva: 5,
    ...
    yeti_2: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.76, def: 1.1, agi: 0.8, mag: 0.63 }, eva: 5,
      elem: { fire: 1.5, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    yeti_3: {
      ...
      flags: [], s: { hp: 1.35, atk: 0.69, agi: 0.8, mag: 0.58 }, eva: 5,
      elem: { fire: 1.5, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    frostling_1: {
      ...
      flags: [], s: { hp: 0.9, mag: 1.2, agi: 1.1 }, eva: 5,
    ...
    frostling_2: {
      ...
      flags: [], s: { hp: 0.9, mag: 1.01, agi: 1.1, atk: 0.84 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_3: {
      ...
      flags: [], s: { hp: 0.95, mag: 0.6, agi: 1.15, atk: 0.5 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_4: {
      ...
      flags: [], s: { hp: 1.15, atk: 0.83, mag: 0.8, agi: 1.05 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_5: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.74, mag: 0.81, agi: 1.05 }, eva: 5,
    ...
    owl_1: {
      ...
      flags: ['flying'], s: { hp: 0.95, agi: 1.2, atk: 1.25, mag: 1.25 }, eva: 12,
    ...
    owl_3: {
      ...
      flags: ['flying'], s: { hp: 0.95, mag: 1.15, agi: 1.2 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    owl_4: {
      ...
      flags: ['flying'], s: { hp: 1.05, mag: 1.3, mdef: 1.25, agi: 1.1 }, eva: 12,
    ...
    mammoth_1: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.1, def: 1.2, agi: 0.7 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    mammoth_2: {
      ...
      flags: [], s: { hp: 1.35, atk: 0.92, def: 1.3, agi: 0.65, mag: 0.8 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    mammoth_3: {
      ...
      flags: [], s: { hp: 1.45, atk: 0.61, def: 1.25, agi: 0.65, mag: 0.51 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
