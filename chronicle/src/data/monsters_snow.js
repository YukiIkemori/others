...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    wolf_1: {
      ...
      flags: [], s: { atk: 0.99, agi: 1.15, hp: 1.28, mag: 0.94 }, eva: 5,
    ...
    wolf_2: {
      ...
      flags: [], s: { atk: 0.78, agi: 1.15, hp: 1.68, mag: 0.71 }, eva: 5,
    ...
    wolf_3: {
      ...
      flags: [], s: { hp: 1.77, atk: 0.38, mag: 0.38, agi: 1.15 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    wolf_4: {
      ...
      flags: [], s: { atk: 0.66, agi: 1.25, hp: 2.5, mag: 0.57 }, eva: 5,
    ...
    wolf_5: {
      ...
      flags: [], s: { hp: 1.56, atk: 0.55, agi: 1.2, mag: 0.55 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    yeti_2: {
      ...
      flags: [], s: { hp: 1.11, atk: 0.88, def: 1.1, agi: 0.8, mag: 0.71 }, eva: 5,
      elem: { fire: 1.5, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    yeti_3: {
      ...
      flags: [], s: { hp: 1.35, atk: 0.72, agi: 0.8, mag: 0.58 }, eva: 5,
      elem: { fire: 1.5, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    frostling_1: {
      ...
      flags: [], s: { hp: 1.11, mag: 0.62, agi: 1.1, atk: 0.57 }, eva: 5,
    ...
    frostling_2: {
      ...
      flags: [], s: { hp: 1.75, mag: 0.65, agi: 1.1, atk: 0.55 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_3: {
      ...
      flags: [], s: { hp: 1.61, mag: 0.3, agi: 1.15, atk: 0.3 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_4: {
      ...
      flags: [], s: { hp: 2.44, atk: 0.46, mag: 0.46, agi: 1.05 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_5: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.51, mag: 0.51, agi: 1.05 }, eva: 5,
    ...
    owl_1: {
      ...
      flags: ['flying'], s: { hp: 1.5, agi: 1.2, atk: 0.96, mag: 0.96 }, eva: 12,
    ...
    owl_3: {
      ...
      flags: ['flying'], s: { hp: 2.01, mag: 0.36, agi: 1.2, atk: 0.36 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    owl_4: {
      ...
      flags: ['flying'], s: { hp: 2.5, mag: 0.45, mdef: 1.25, agi: 1.1, atk: 0.45 }, eva: 12,
    ...
    mammoth_1: {
      ...
      flags: [], s: { atk: 1.1, def: 1.2, agi: 0.7, hp: 0.93 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    mammoth_2: {
      ...
      flags: [], s: { hp: 0.97, atk: 1.15, def: 1.3, agi: 0.65 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    mammoth_3: {
      ...
      flags: [], s: { hp: 1.45, atk: 0.78, def: 1.25, agi: 0.65, mag: 0.65 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
