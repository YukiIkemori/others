...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    wolf_1: {
      ...
      flags: [], s: { atk: 1.03, agi: 1.15, hp: 1.1, mag: 0.99 }, eva: 5,
    ...
    wolf_2: {
      ...
      flags: [], s: { atk: 0.98, agi: 1.15, hp: 1.18, mag: 0.9 }, eva: 5,
    ...
    wolf_3: {
      ...
      flags: [], s: { hp: 1.32, atk: 0.59, mag: 0.61, agi: 1.15 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    wolf_4: {
      ...
      flags: [], s: { atk: 0.82, agi: 1.25, hp: 1.34, mag: 0.72 }, eva: 5,
    ...
    wolf_5: {
      ...
      flags: [], s: { hp: 1.85, atk: 0.54, agi: 1.2, mag: 0.47 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    yeti_1: {
      ...
      flags: [], s: { hp: 1.32, atk: 1.13, agi: 0.8, mag: 0.99 }, eva: 5,
    ...
    yeti_2: {
      ...
      flags: [], s: { hp: 1.53, atk: 0.65, def: 1.1, agi: 0.8, mag: 0.54 }, eva: 5,
      elem: { fire: 1.5, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    yeti_3: {
      ...
      flags: [], s: { hp: 1.86, atk: 0.46, agi: 0.8, mag: 0.39 }, eva: 5,
      elem: { fire: 1.5, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    frostling_1: {
      ...
      flags: [], s: { hp: 0.99, mag: 1.18, agi: 1.1, atk: 0.99 }, eva: 5,
    ...
    frostling_2: {
      ...
      flags: [], s: { hp: 1.06, mag: 0.9, agi: 1.1, atk: 0.75 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_3: {
      ...
      flags: [], s: { hp: 1.2, mag: 0.48, agi: 1.15, atk: 0.4 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_4: {
      ...
      flags: [], s: { hp: 1.54, atk: 0.59, mag: 0.57, agi: 1.05 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5, light: 0.5, dark: 1.5 }, phys: {}, statusRes: { confuse: 0.5 },
    ...
    frostling_5: {
      ...
      flags: [], s: { hp: 1.85, atk: 0.46, mag: 0.51, agi: 1.05 }, eva: 5,
    ...
    owl_1: {
      ...
      flags: ['flying'], s: { hp: 1.05, agi: 1.2, atk: 1.23, mag: 1.23 }, eva: 12,
    ...
    owl_2: {
      ...
      flags: ['flying'], s: { hp: 1.12, mag: 0.98, agi: 1.15, atk: 0.9 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    owl_3: {
      ...
      flags: ['flying'], s: { hp: 1.2, mag: 0.93, agi: 1.2, atk: 0.81 }, eva: 12,
      elem: { wind: 1.5, earth: 0.5 }, phys: { pierce: 1.25 }, statusRes: {},
    ...
    owl_4: {
      ...
      flags: ['flying'], s: { hp: 1.45, mag: 0.87, mdef: 1.25, agi: 1.1, atk: 0.67 }, eva: 12,
    ...
    mammoth_1: {
      ...
      flags: [], s: { hp: 1.43, atk: 1.08, def: 1.2, agi: 0.7, mag: 0.99 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    mammoth_2: {
      ...
      flags: [], s: { hp: 1.65, atk: 0.78, def: 1.3, agi: 0.65, mag: 0.68 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    mammoth_3: {
      ...
      flags: [], s: { hp: 2, atk: 0.41, def: 1.25, agi: 0.65, mag: 0.34 }, eva: 5,
      elem: { fire: 1.25, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
