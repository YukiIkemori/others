...
(function (R) {
  ...
  const ITEMS = {
    // ---------------------------------------------------------------- monster rares (42)
    // crab_1 · def+4
    sh_crab_shell: { name: 'カニの甲羅盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 1, units: 'v1', src: 'mdrop',
      mods: { def: 4 },
      desc: '守備力が上がる。' },
    // golem_1 beetle_1 crystal_1 · sres:stun30
    sh_ore_shield: { name: '鉱石の盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 1, units: 'v1', src: 'mdrop',
      mods: { statusResist: { stun: 0.3 } },
      desc: '気絶にかかりにくい。' },
    // armor_1 wyvern_1 · mdef+4
    sh_star_buckler: { name: '星の小盾', type: 'shield', weight: 'light', grade: 'rare', tier: 1, units: 'd1', src: 'mdrop',
      mods: { mdef: 4 },
      desc: '術防が上がる。' },
    // mushroom_1 treant_1 · sres:sleep30
    hd_mushroom_cap: { name: 'キノコの帽子', type: 'head', weight: 'cloth', grade: 'rare', tier: 1, units: 'm1', src: 'mdrop',
      mods: { statusResist: { sleep: 0.3 } },
      desc: '眠りにかかりにくい。' },
    // ghost_1 wisp_1 doll_1 · sres:confuse30
    hd_mist_hood: { name: '霧の頭巾', type: 'head', weight: 'cloth', grade: 'rare', tier: 1, units: 'm1', src: 'mdrop',
      mods: { statusResist: { confuse: 0.3 } },
      desc: '混乱にかかりにくい。' },
    // salamander_1 imp_1 gargoyle_1 · sres:blind30
    hd_ash_mask: { name: '灰よけの面', type: 'head', weight: 'light', grade: 'rare', tier: 1, units: 'a1', src: 'mdrop',
      mods: { statusResist: { blind: 0.3 } },
      desc: '暗闇にかかりにくい。' },
    // eyeball_1 darkmage_1 automaton_1 · glim:spell10
    hd_star_hood: { name: '星見の頭巾', type: 'head', weight: 'cloth', grade: 'rare', tier: 1, units: 'i1', src: 'mdrop',
      mods: { glimPct: { spell: 10 } },
      desc: '術を閃きやすい。' },
    // mummy_1 cactus_1 · sres:blind30
    bd_wrap_cloth: { name: '砂よけの布', type: 'body', weight: 'cloth', grade: 'rare', tier: 1, units: 'i2', src: 'mdrop',
      mods: { statusResist: { blind: 0.3 } },
      desc: '暗闇にかかりにくい。' },
    // wolf_1 yeti_1 owl_1 · res:water0.75
    bd_wolf_pelt: { name: 'オオカミの毛皮', type: 'body', weight: 'light', grade: 'rare', tier: 1, units: 'a2', src: 'mdrop',
      mods: { elemResist: { water: 0.75 } },
      desc: '水のダメージを少し減らす。' },
    // frog_1 lizardman_1 spider_1 · sres:poison30
    bd_marsh_coat: { name: '沼の雨よけ', type: 'body', weight: 'light', grade: 'rare', tier: 1, units: 'd2', src: 'mdrop',
      mods: { statusResist: { poison: 0.3 } },
      desc: '毒にかかりにくい。' },
    // mole_1 goblin_1 · crit+5
    hn_mole_claw: { name: 'モグラの爪', type: 'hands', weight: 'light', grade: 'rare', tier: 1, units: 'a1', src: 'mdrop',
      mods: { crit: 5 },
      desc: '会心が出やすい。' },
    // rat_1 · eva+4
    ft_rat_sandal: { name: 'ネズミ革のサンダル', type: 'feet', weight: 'light', grade: 'rare', tier: 1, units: 'a1', src: 'mdrop',
      mods: { eva: 4 },
      desc: '攻撃をかわしやすい。' },
    // jelly_2 · res:water0.5
    sh_bubble: { name: '泡の盾', type: 'shield', weight: 'cloth', grade: 'rare', tier: 3, units: 'm1', src: 'mdrop',
      mods: { elemResist: { water: 0.5 } },
      desc: '水のダメージを減らす。' },
    // merman_2 skeleton_2 · res:water0.5
    sh_tide_shield: { name: '潮の盾', type: 'shield', weight: 'light', grade: 'rare', tier: 3, units: 'd1', src: 'mdrop',
      mods: { elemResist: { water: 0.5 } },
      desc: '水のダメージを減らす。' },
    // armor_2 · sres:stun30
    hd_sentry_helm: { name: '番兵の兜', type: 'head', weight: 'heavy', grade: 'rare', tier: 3, units: 'v1', src: 'mdrop',
      mods: { statusResist: { stun: 0.3 } },
      desc: '気絶にかかりにくい。' },
    // crab_2 · res:water0.5
    bd_crab_plate: { name: '甲羅の胸当て', type: 'body', weight: 'heavy', grade: 'rare', tier: 3, units: 'v2', src: 'mdrop',
      mods: { elemResist: { water: 0.5 } },
      desc: '水のダメージを減らす。' },
    // rat_2 · stealPct+25
    hn_rat_claw: { name: 'ネズミのかぎ爪', type: 'hands', weight: 'light', grade: 'rare', tier: 3, units: 'a1', src: 'mdrop',
      mods: { stealPct: 25 },
      desc: '盗みが成功しやすい。' },
    // mummy_2 cactus_2 · glim:dark15
    hn_curse_wrap: { name: '呪い布の手甲', type: 'hands', weight: 'cloth', grade: 'rare', tier: 3, units: 'i1', src: 'mdrop',
      mods: { glimPct: { dark: 15 } },
      desc: '闇の術を閃きやすい。' },
    // scorpion_3 snake_3 cactus_3 · sres:poison40
    sh_scorpion_shell: { name: 'サソリの甲羅盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 5, units: 's1', src: 'mdrop',
      mods: { statusResist: { poison: 0.4 } },
      desc: '毒にかかりにくい。' },
    // ghost_3 wisp_3 doll_3 · sres:sleep40
    sh_bell_shield: { name: '鐘の盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 5, units: 's1', src: 'mdrop',
      mods: { statusResist: { sleep: 0.4 } },
      desc: '眠りにかかりにくい。' },
    // chimera_2 wyvern_2 · res:wind0.5
    sh_wyvern_scale: { name: '飛竜のうろこ盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 5, units: 's1', src: 'mdrop',
      mods: { elemResist: { wind: 0.5 } },
      desc: '風のダメージを減らす。' },
    // bat_3 · sres:confuse40
    hd_sonic_band: { name: '音波の鉢巻き', type: 'head', weight: 'light', grade: 'rare', tier: 5, units: 'a1', src: 'mdrop',
      mods: { statusResist: { confuse: 0.4 } },
      desc: '混乱にかかりにくい。' },
    // crab_3 · res:water0.5
    hd_foam_cap: { name: '泡の帽子', type: 'head', weight: 'cloth', grade: 'rare', tier: 5, units: 'm1', src: 'mdrop',
      mods: { elemResist: { water: 0.5 } },
      desc: '水のダメージを減らす。' },
    // seabird_3 · stealPct+30
    hd_thief_bandana: { name: '盗人のバンダナ', type: 'head', weight: 'light', grade: 'rare', tier: 5, units: 'a1', src: 'mdrop',
      mods: { stealPct: 30 },
      desc: '盗みが成功しやすい。' },
    // paper_2 · sres:silence40
    bd_blank_coat: { name: '白紙のマント', type: 'body', weight: 'cloth', grade: 'rare', tier: 5, units: 'm2', src: 'mdrop',
      mods: { statusResist: { silence: 0.4 } },
      desc: '沈黙にかかりにくい。' },
    // bee_3 plant_3 treant_3 · res:earth0.5
    bd_leaf_mail: { name: '葉の鎧', type: 'body', weight: 'light', grade: 'rare', tier: 5, units: 'd2', src: 'mdrop',
      mods: { elemResist: { earth: 0.5 } },
      desc: '土のダメージを減らす。' },
    // frog_3 lizardman_3 spider_3 · sres:paralyze40
    bd_bog_mail: { name: '沼の鎖編み鎧', type: 'body', weight: 'heavy', grade: 'rare', tier: 5, units: 'v2', src: 'mdrop',
      mods: { statusResist: { paralyze: 0.4 } },
      desc: 'まひにかかりにくい。' },
    // salamander_3 imp_3 gargoyle_3 · res:fire0.5
    bd_ash_cloak: { name: '灰のマント', type: 'body', weight: 'cloth', grade: 'rare', tier: 5, units: 'i2', src: 'mdrop',
      mods: { elemResist: { fire: 0.5 } },
      desc: '火のダメージを減らす。' },
    // armor_3 · def+8
    bd_knight_mail: { name: '騎士の古鎧', type: 'body', weight: 'heavy', grade: 'rare', tier: 5, units: 'v2', src: 'mdrop',
      mods: { def: 8 },
      desc: '守備力が上がる。' },
    // jelly_3 · sres:poison40
    hn_jelly_glove: { name: 'ゼリーの手袋', type: 'hands', weight: 'cloth', grade: 'rare', tier: 5, units: 'm1', src: 'mdrop',
      mods: { statusResist: { poison: 0.4 } },
      desc: '毒にかかりにくい。' },
    // paper_3 · sres:silence50
    sh_blank_shield: { name: '白紙の盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 7, units: 's1', src: 'mdrop',
      mods: { statusResist: { silence: 0.5 } },
      desc: '沈黙にかかりにくい。' },
    // crab_4 · def+10
    sh_castle_shell: { name: '城ガニの盾', type: 'shield', weight: 'heavy', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop',
      mods: { def: 10 },
      desc: '守備力が上がる。' },
    // jelly_4 · hpPct+8
    hd_jelly_helm: { name: 'ゼリーの兜', type: 'head', weight: 'heavy', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop',
      mods: { hpPct: 8 },
      desc: '最大HPが上がる。' },
    // rat_4 · goldPct+20
    hd_rat_bandana: { name: '頭領のバンダナ', type: 'head', weight: 'light', grade: 'rare', tier: 7, units: 'a1', src: 'mdrop',
      mods: { goldPct: 20 },
      desc: '手に入るお金が増える。' },
    // mushroom_4 fairy_4 · healPct+15
    hd_fairy_circlet: { name: '妖精の冠', type: 'head', weight: 'cloth', grade: 'rare', tier: 7, units: 'm1', src: 'mdrop',
      mods: { healPct: 15 },
      desc: '回復の術がよく効く。' },
    // yeti_3 mammoth_3 · res:water0.5
    hd_yeti_fur: { name: '雪男の毛帽', type: 'head', weight: 'light', grade: 'rare', tier: 7, units: 'a1', src: 'mdrop',
      mods: { elemResist: { water: 0.5 } },
      desc: '水のダメージを減らす。' },
    // armor_4 wyvern_3 · sres:stun50
    hd_blackgold_helm: { name: '黒金の兜', type: 'head', weight: 'heavy', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop',
      mods: { statusResist: { stun: 0.5 } },
      desc: '気絶にかかりにくい。' },
    // scribe_1 book_1 · sres:silence50
    hd_scribe_hood: { name: '書記の頭巾', type: 'head', weight: 'cloth', grade: 'rare', tier: 7, units: 'i1', src: 'mdrop',
      mods: { statusResist: { silence: 0.5 } },
      desc: '沈黙にかかりにくい。' },
    // bat_4 · res:dark0.5
    bd_night_cloak: { name: '夜のマント', type: 'body', weight: 'cloth', grade: 'rare', tier: 7, units: 'i2', src: 'mdrop',
      mods: { elemResist: { dark: 0.5 } },
      desc: '闇のダメージを減らす。' },
    // seabird_4 · res:wind0.5
    bd_gull_robe: { name: '潮風の薄衣', type: 'body', weight: 'cloth', grade: 'rare', tier: 7, units: 'i2', src: 'mdrop',
      mods: { elemResist: { wind: 0.5 } },
      desc: '風のダメージを減らす。' },
    // scribe_2 book_2 · mdef+10
    bd_scribe_coat: { name: '記録院の白衣', type: 'body', weight: 'cloth', grade: 'rare', tier: 7, units: 'i2', src: 'mdrop',
      mods: { mdef: 10 },
      desc: '術防が上がる。' },
    // void_3 · res:dark0.5 sres:death50
    hd_void_helm: { name: '虚無の兜', type: 'head', weight: 'heavy', grade: 'rare', tier: 9, units: 's1', src: 'mdrop',
      mods: { elemResist: { dark: 0.5 }, statusResist: { death: 0.5 } },
      desc: '闇のダメージを減らす。\n即死にかかりにくい。' },
    // ---------------------------------------------------------------- monster supers (65)
