...
(function (R) {
  ...
  const ITEMS = {
    // ---------------------------------------------------------------- monster rares (40)
    // jelly_1 · hpPct+5
    ac_jelly_ring: { name: 'ゼリーの指輪', type: 'acc', grade: 'rare', tier: 1, units: 'v1', src: 'mdrop', quirk: true,
      mods: { hpPct: 5, /* クセ */ elemResist: { fire: 1.25 } },
      desc: '最大HPが上がる。ただし火に弱くなる。' },
    // bat_1 · escapePct+25
    ac_bat_fang: { name: 'コウモリの牙飾り', type: 'acc', grade: 'rare', tier: 1, units: 's1', src: 'mdrop', quirk: true,
      mods: { escapePct: 25, /* クセ */ elemResist: { light: 1.25 } },
      desc: '逃げやすくなる。ただし光に弱くなる。' },
    // seabird_1 · spd+6
    ac_gull_feather: { name: 'カモメの羽根飾り', type: 'acc', grade: 'rare', tier: 1, units: 'a1', src: 'mdrop', quirk: true,
      mods: { spd: 6, /* クセ */ encounterPct: 50 },
      desc: 'すばやく動ける。ただし魔物を呼ぶ。' },
    // frostling_1 mammoth_1 · sres:freeze30
    ac_snow_crystal: { name: '雪の結晶', type: 'acc', grade: 'rare', tier: 1, units: 'i1', src: 'mdrop', quirk: true,
      mods: { statusResist: { freeze: 0.3 }, /* クセ */ elemResist: { fire: 1.25 } },
      desc: '凍結にかかりにくい。ただし火に弱くなる。' },
    // mimic_1 · goldPct+20
    ac_mimic_tongue: { name: '宝箱の舌', type: 'acc', grade: 'rare', tier: 1, units: 'v1', src: 'mdrop', quirk: true,
      mods: { goldPct: 20, /* クセ */ expPct: -25 },
      desc: '手に入るお金が増える。\nただし経験値が減る。' },
    // paper_1 · sres:silence40
    ac_blank_page: { name: '白紙の一枚', type: 'acc', grade: 'rare', tier: 3, units: 'm1', src: 'mdrop', quirk: true,
      mods: { statusResist: { silence: 0.4, /* クセ */ confuse: -0.25 } },
      desc: '沈黙にかかりにくい。ただし混乱に弱い。' },
    // fairy_2 treant_2 · regen
    ac_honey_charm: { name: '蜂蜜のお守り', type: 'acc', grade: 'rare', tier: 3, units: 'i1', src: 'mdrop', quirk: true,
      mods: { regen: true, /* クセ */ encounterPct: 50 },
      desc: '戦闘中、HPが少しずつ戻る。\nただし魔物を呼ぶ。' },
    // crystal_2 · boost:fire15
    ac_ruby_chip: { name: '紅水晶のかけら', type: 'acc', grade: 'rare', tier: 3, units: 'v1', src: 'mdrop', quirk: true,
      mods: { elemBoost: { fire: 15 }, /* クセ */ elemResist: { water: 1.25 } },
      desc: '火の攻撃が強くなる。ただし水に弱くなる。' },
    // mimic_2 · dropPct+20
    ac_mimic_key: { name: '宝箱の合い鍵', type: 'acc', grade: 'rare', tier: 3, units: 'v1', src: 'mdrop', quirk: true,
      mods: { dropPct: 20, /* クセ */ goldPct: -25 },
      desc: '魔物がアイテムを落としやすい。\nただしお金が減る。' },
    // mushroom_3 fairy_3 · mpRegen+1
    ac_fairy_dust: { name: '妖精の粉袋', type: 'acc', grade: 'rare', tier: 5, units: 'm1', src: 'mdrop', quirk: true,
      mods: { mpRegen: 1, /* クセ */ hpPct: -10 },
      desc: '戦闘中、MPが少しずつ戻る。\nただし最大HPが下がる。' },
    // wolf_3 frostling_3 owl_3 · res:water0.5
    ac_blizzard_charm: { name: '吹雪のお守り', type: 'acc', grade: 'rare', tier: 5, units: 's1', src: 'mdrop', quirk: true,
      mods: { elemResist: { water: 0.5, /* クセ */ fire: 1.25 } },
      desc: '水のダメージを減らす。\nただし火に弱くなる。' },
    // merman_3 skeleton_3 · mdef+6
    ac_pearl_ear: { name: '真珠の耳飾り', type: 'acc', grade: 'rare', tier: 5, units: 'v1', src: 'mdrop', quirk: true,
      mods: { mdef: 6, /* クセ */ defPct: -25 },
      desc: '術防が上がる。ただし守備力が下がる。' },
    // mole_3 beetle_3 goblin_3 · hit+8
    ac_gem_eye: { name: '宝石の目', type: 'acc', grade: 'rare', tier: 5, units: 's1', src: 'mdrop', quirk: true,
      mods: { hit: 8, /* クセ */ takenPct: 15 },
      desc: 'よく当たる。\nただし受けるダメージが増える。' },
    // crystal_3 · boost:water15
    ac_sapphire_chip: { name: '青水晶のかけら', type: 'acc', grade: 'rare', tier: 5, units: 'v1', src: 'mdrop', quirk: true,
      mods: { elemBoost: { water: 15 }, /* クセ */ elemResist: { fire: 1.25 } },
      desc: '水の攻撃が強くなる。ただし火に弱くなる。' },
    // eyeball_3 darkmage_3 automaton_3 · glim:spell15
    ac_astrolabe: { name: '小さな天球儀', type: 'acc', grade: 'rare', tier: 5, units: 'i1', src: 'mdrop', quirk: true,
      mods: { glimPct: { spell: 15, /* クセ */ tech: -50 } },
      desc: '術を閃きやすい。ただし技を閃きにくい。' },
    // mimic_3 · rarePct+20
    ac_mimic_chain: { name: '呪い宝箱の鎖', type: 'acc', grade: 'rare', tier: 5, units: 'v1', src: 'mdrop', quirk: true,
      mods: { rarePct: 20, /* クセ */ goldPct: -25 },
      desc: 'レアアイテムを落としやすい。\nただしお金が減る。' },
    // quicksilver_1 · expPct+15
    ac_silver_drop: { name: '白銀のひとしずく', type: 'acc', grade: 'rare', tier: 5, units: 'v1', src: 'mdrop', quirk: true,
      mods: { expPct: 15, /* クセ */ goldPct: -25 },
      desc: '経験値が増える。ただしお金が減る。' },
    // mirror_1 · res:light0.5
    ac_mirror_scale: { name: '鏡のうろこ', type: 'acc', grade: 'rare', tier: 5, units: 'd1', src: 'mdrop', quirk: true,
      mods: { elemResist: { light: 0.5, /* クセ */ dark: 1.25 } },
      desc: '光のダメージを減らす。\nただし闇に弱くなる。' },
    // jelly_5 · res:fire0.75 res:water0.75 res:wind0.75 res:earth0.75
    ac_rainbow_drop: { name: '七色の粒', type: 'acc', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop', quirk: true,
      mods: { elemResist: { fire: 0.75, water: 0.75, wind: 0.75, earth: 0.75 }, /* クセ */ hpPct: -10 },
      desc: '火・水・風・土のダメージを少し減らす。\nただし最大HPが下がる。' },
    // bat_5 · regen
    ac_count_brooch: { name: '夜公爵のブローチ', type: 'acc', grade: 'rare', tier: 7, units: 's1', src: 'mdrop', quirk: true,
      mods: { regen: true, /* クセ */ elemResist: { light: 1.25 } },
      desc: '戦闘中、HPが少しずつ戻る。\nただし光に弱くなる。' },
    // bee_5 plant_5 · hpPct+10
    ac_millennium_seed: { name: '千年の種', type: 'acc', grade: 'rare', tier: 7, units: 'd1', src: 'mdrop', quirk: true,
      mods: { hpPct: 10, /* クセ */ elemResist: { fire: 1.25 } },
      desc: '最大HPが上がる。ただし火に弱くなる。' },
    // scorpion_5 mummy_5 · imm:death
    ac_royal_ankh: { name: '王家の護符', type: 'acc', grade: 'rare', tier: 7, units: 'd1', src: 'mdrop', quirk: true,
      mods: { statusImmune: ['death'], /* クセ */ takenPct: 15 },
      desc: '即死が効かない。\nただし受けるダメージが増える。' },
    // mummy_4 · imm:death
    ac_scarab: { name: '聖甲虫の護符', type: 'acc', grade: 'rare', tier: 7, units: 'i1', src: 'mdrop', quirk: true,
      mods: { statusImmune: ['death'], /* クセ */ spd: -15 },
      desc: '即死が効かない。ただし動きが遅くなる。' },
    // ghost_5 · res:dark0.5
    ac_underworld_bell: { name: '冥界の鈴', type: 'acc', grade: 'rare', tier: 7, units: 'm1', src: 'mdrop', quirk: true,
      mods: { elemResist: { dark: 0.5, /* クセ */ light: 1.25 } },
      desc: '闇のダメージを減らす。\nただし光に弱くなる。' },
    // doll_4 lizardman_4 spider_4 · res:dark0.5
    ac_soul_candle: { name: '魂のろうそく', type: 'acc', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop', quirk: true,
      mods: { elemResist: { dark: 0.5, /* クセ */ wind: 1.25 } },
      desc: '闇のダメージを減らす。\nただし風に弱くなる。' },
    // skeleton_5 · buff:atk+1
    ac_admiral_medal: { name: '提督の勲章', type: 'acc', grade: 'rare', tier: 7, units: 'i1', src: 'mdrop', quirk: true,
      mods: { startBuffs: { atk: 1 }, /* クセ */ mdefPct: -25 },
      desc: '戦闘の始めに攻撃が上がる。\nただし術防が下がる。' },
    // golem_3 crystal_4 · mdef+8
    ac_gem_core: { name: '宝玉の核', type: 'acc', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop', quirk: true,
      mods: { mdef: 8, /* クセ */ spd: -15 },
      desc: '術防が上がる。ただし動きが遅くなる。' },
    // goblin_5 · goldPct+20
    ac_goblin_hoard: { name: '小鬼の財宝袋', type: 'acc', grade: 'rare', tier: 7, units: 'd1', src: 'mdrop', quirk: true,
      mods: { goldPct: 20, /* クセ */ expPct: -25 },
      desc: '手に入るお金が増える。\nただし経験値が減る。' },
    // salamander_5 imp_5 · boost:fire20
    ac_phoenix_ash: { name: '炎鳥の灰', type: 'acc', grade: 'rare', tier: 7, units: 's1', src: 'mdrop', quirk: true,
      mods: { elemBoost: { fire: 20 }, /* クセ */ elemResist: { water: 1.25 } },
      desc: '火の攻撃が強くなる。ただし水に弱くなる。' },
    // eyeball_5 · res:light0.5
    ac_heaven_feather: { name: '天の羽根', type: 'acc', grade: 'rare', tier: 7, units: 'i1', src: 'mdrop', quirk: true,
      mods: { elemResist: { light: 0.5, /* クセ */ dark: 1.25 } },
      desc: '光のダメージを減らす。\nただし闇に弱くなる。' },
    // scribe_3 book_3 demon_1 · glim:spell15
    ac_archive_key: { name: '書庫の鍵', type: 'acc', grade: 'rare', tier: 7, units: 'd1', src: 'mdrop', quirk: true,
      mods: { glimPct: { spell: 15, /* クセ */ tech: -50 } },
      desc: '術を閃きやすい。ただし技を閃きにくい。' },
    // mimic_4 · rarePct+20
    ac_abyss_key: { name: '奈落の鍵', type: 'acc', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop', quirk: true,
      mods: { rarePct: 20, /* クセ */ goldPct: -25 },
      desc: 'レアアイテムを落としやすい。\nただしお金が減る。' },
    // quicksilver_2 · expPct+15
    ac_silver_orb: { name: '白銀の玉', type: 'acc', grade: 'rare', tier: 7, units: 'v1', src: 'mdrop', quirk: true,
      mods: { expPct: 15, /* クセ */ goldPct: -25 },
      desc: '経験値が増える。ただしお金が減る。' },
    // mirror_2 · mdef+10
    ac_mirror_crest: { name: '鏡の紋章', type: 'acc', grade: 'rare', tier: 7, units: 'd1', src: 'mdrop', quirk: true,
      mods: { mdef: 10, /* クセ */ defPct: -25 },
      desc: '術防が上がる。ただし守備力が下がる。' },
    // platinum_1 · expPct+15
    ac_platinum_flame: { name: '白金の炎', type: 'acc', grade: 'rare', tier: 7, units: 'm1', src: 'mdrop', quirk: true,
      mods: { expPct: 15, /* クセ */ elemResist: { water: 1.25 } },
      desc: '経験値が増える。ただし水に弱くなる。' },
    // void_1 void_2 demon_2 · res:dark0.5
    ac_void_shard: { name: '虚無のかけら', type: 'acc', grade: 'rare', tier: 9, units: 'm1', src: 'mdrop', quirk: true,
      mods: { elemResist: { dark: 0.5, /* クセ */ light: 1.25 } },
      desc: '闇のダメージを減らす。\nただし光に弱くなる。' },
    // platinum_2 · expPct+15
    ac_platinum_crown: { name: '白金の灯冠', type: 'acc', grade: 'rare', tier: 9, units: 'm1', src: 'mdrop', quirk: true,
      mods: { expPct: 15, /* クセ */ goldPct: -25 },
      desc: '経験値が増える。ただしお金が減る。' },
    // chaos_3 · sres:confuse50 boost:dark20
    ac_chaos_eye: { name: '混沌の瞳', type: 'acc', grade: 'rare', tier: 9, units: 's1', src: 'mdrop', quirk: true,
      mods: { statusResist: { confuse: 0.5 }, elemBoost: { dark: 20 }, /* クセ */ elemResist: { light: 1.25 } },
