...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    scorpion_1: {
      ...
      flags: [], s: { def: 1.2, hp: 1.27, atk: 0.8, mag: 0.8 }, eva: 5,
    ...
    scorpion_2: {
      ...
      flags: [], s: { atk: 0.72, def: 1.2, hp: 1.54, mag: 0.69 }, eva: 5,
    ...
    scorpion_3: {
      ...
      flags: [], s: { hp: 1.67, def: 1.5, agi: 0.85, atk: 1.06, mag: 1.06 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    scorpion_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.65, def: 1.2, mag: 0.57 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    scorpion_5: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.58, def: 1.4, agi: 0.9, mag: 0.52 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    snake_1: {
      ...
      flags: [], s: { atk: 0.89, agi: 1.05, hp: 1.31, mag: 0.86 }, eva: 5,
    ...
    snake_2: {
      ...
      flags: [], s: { atk: 0.94, agi: 1.1, hp: 1.72, mag: 0.89 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    snake_3: {
      ...
      flags: [], s: { hp: 1.76, mag: 1.39, agi: 1.05, atk: 1.26 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    snake_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.78, agi: 0.95, mag: 0.67 }, eva: 5,
    ...
    mummy_1: {
      ...
      flags: [], s: { hp: 1.25, agi: 0.8, atk: 2.06, mag: 2.06 }, eva: 5,
    ...
    mummy_2: {
      ...
      flags: [], s: { hp: 2.08, mag: 2.38, agi: 0.8, atk: 2.38 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    mummy_3: {
      ...
      flags: [], s: { atk: 0.66, mag: 1.08, mdef: 1.3, hp: 1.82 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    mummy_4: {
      ...
      flags: [], s: { hp: 2.44, atk: 0.87, def: 1.15, agi: 0.85, mag: 0.73 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    mummy_5: {
      ...
      flags: [], s: { hp: 2.18, mag: 0.52, mdef: 1.2, agi: 0.85, atk: 0.5 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    cactus_1: {
      ...
      flags: [], s: { hp: 1.31, def: 1.1, agi: 0.85, atk: 0.96, mag: 0.96 }, eva: 5,
    ...
    cactus_2: {
      ...
      flags: [], s: { hp: 2.07, atk: 0.54, def: 1.1, agi: 0.85, mag: 0.52 }, eva: 5,
      elem: { fire: 1.25, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    cactus_3: {
      ...
      flags: [], s: { hp: 1.38, mag: 1.03, agi: 0.85, atk: 0.93 }, eva: 5,
      elem: { fire: 1.25, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    cactus_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.65, def: 1.2, agi: 0.85, mag: 0.56 }, eva: 5,
    ...
    sandworm_1: {
      ...
      flags: [], s: { atk: 1.1, agi: 0.7, mag: 1.04 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    sandworm_2: {
      ...
      flags: [], s: { hp: 1.2, def: 1.3, agi: 0.65, atk: 0.85, mag: 0.85 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    sandworm_3: {
      ...
      flags: [], s: { hp: 2.14, atk: 0.67, def: 1.2, agi: 0.65, mag: 0.58 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
