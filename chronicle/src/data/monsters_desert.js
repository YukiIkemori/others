...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    scorpion_1: {
      ...
      flags: [], s: { def: 1.2, atk: 1.25, mag: 1.25 }, eva: 5,
    ...
    scorpion_2: {
      ...
      flags: [], s: { atk: 1.05, def: 1.2 }, eva: 5,
    ...
    scorpion_3: {
      ...
      flags: [], s: { hp: 1.1, def: 1.5, agi: 0.85 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    scorpion_4: {
      ...
      flags: [], s: { hp: 1.05, atk: 1.15, def: 1.2 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    scorpion_5: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.1, def: 1.4, agi: 0.9 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    snake_1: {
      ...
      flags: [], s: { atk: 1.31, agi: 1.05, mag: 1.25 }, eva: 5,
    ...
    snake_3: {
      ...
      flags: [], s: { hp: 1.05, mag: 1.1, agi: 1.05 }, eva: 5,
      elem: { fire: 1.25 }, phys: {}, statusRes: {},
    ...
    snake_4: {
      ...
      flags: [], s: { hp: 1.35, atk: 1.15, agi: 0.95 }, eva: 5,
    ...
    mummy_1: {
      ...
      flags: [], s: { hp: 1.15, agi: 0.8, atk: 1.25, mag: 1.25 }, eva: 5,
    ...
    mummy_2: {
      ...
      flags: [], s: { hp: 1.1, mag: 1.1, agi: 0.8 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    mummy_3: {
      ...
      flags: [], s: { atk: 0.8, mag: 1.3, mdef: 1.3 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    mummy_4: {
      ...
      flags: [], s: { hp: 1.25, atk: 1.2, def: 1.15, agi: 0.85 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    mummy_5: {
      ...
      flags: [], s: { hp: 1.3, mag: 1.25, mdef: 1.2, agi: 0.85 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    cactus_1: {
      ...
      flags: [], s: { hp: 1.1, def: 1.1, agi: 0.85 }, eva: 5,
    ...
    cactus_2: {
      ...
      flags: [], s: { hp: 1.1, atk: 1.05, def: 1.1, agi: 0.85 }, eva: 5,
      elem: { fire: 1.25, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    cactus_3: {
      ...
      flags: [], s: { hp: 1.15, mag: 1.1, agi: 0.85 }, eva: 5,
      elem: { fire: 1.25, water: 0.5, earth: 0.75 }, phys: { slash: 1.25 }, statusRes: { sleep: 0.5, poison: 0.5 },
    ...
    cactus_4: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.15, def: 1.2, agi: 0.85 }, eva: 5,
    ...
    sandworm_1: {
      ...
      flags: [], s: { hp: 1.2, atk: 1.05, agi: 0.7 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    sandworm_2: {
      ...
      flags: [], s: { hp: 1.25, def: 1.3, agi: 0.65, atk: 0.75, mag: 0.75 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
    ...
    sandworm_3: {
      ...
      flags: [], s: { hp: 1.35, atk: 0.61, def: 1.2, agi: 0.65, mag: 0.53 }, eva: 5,
      elem: { wind: 1.5, earth: 0.25 }, phys: {}, statusRes: { poison: 0.5 },
