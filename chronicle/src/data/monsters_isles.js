...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    merman_2: {
      ...
      flags: [], s: { hp: 1.05, atk: 0.98, mag: 0.85 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    merman_3: {
      ...
      flags: [], s: { hp: 0.95, atk: 0.5, mag: 0.75, mdef: 1.2 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    merman_4: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.96, def: 1.25, mag: 0.83 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    kraken_2: {
      ...
      flags: [], s: { hp: 1.2, atk: 0.84, agi: 0.85, mag: 0.76 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    kraken_3: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.61, mag: 0.64, agi: 0.85 }, eva: 5,
      elem: { fire: 0.75, water: 0.25, earth: 1.5 }, phys: {}, statusRes: {},
    ...
    skeleton_1: {
      ...
      flags: [], s: { atk: 1.31, mag: 1.25 }, eva: 5,
    ...
    skeleton_2: {
      ...
      flags: [], s: { atk: 1.1, agi: 1.05 }, rw: { gold: 1.5 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    skeleton_4: {
      ...
      flags: [], s: { hp: 1.1, atk: 1.1, mag: 1.1 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
    ...
    skeleton_5: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.15, mag: 1.1 }, eva: 5,
      elem: { fire: 1.5, light: 2, dark: -1 }, phys: { blunt: 1.25 }, statusRes: { poison: 1, death: 1, sleep: 1, confuse: 0.5 },
