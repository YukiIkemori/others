...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    eyeball_1: {
      ...
      flags: [], s: { hp: 0.99, mag: 1.08, agi: 1.1, atk: 0.99 }, eva: 5,
    ...
    eyeball_2: {
      ...
      flags: [], s: { hp: 1.06, mag: 1.03, agi: 1.1, atk: 0.9 }, eva: 5,
      elem: { light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_3: {
      ...
      flags: [], s: { hp: 1.2, mag: 0.97, agi: 1.1, atk: 0.81 }, eva: 5,
    ...
    eyeball_4: {
      ...
      flags: [], s: { mag: 0.66, mdef: 1.2, agi: 1.1, atk: 0.53, hp: 1.34 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_5: {
      ...
      flags: [], s: { hp: 1.85, mag: 0.39, mdef: 1.25, agi: 1.05, atk: 0.31 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    darkmage_1: {
      ...
      flags: [], s: { hp: 0.99, atk: 0.74, mag: 1.28, def: 0.85, mdef: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    darkmage_2: {
      ...
      flags: [], s: { hp: 1.06, atk: 0.67, mag: 1.21, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    darkmage_3: {
      ...
      flags: [], s: { hp: 1.13, atk: 0.6, mag: 1.09, def: 0.85, mdef: 1.3, agi: 1.15 }, eva: 5,
    ...
    darkmage_4: {
      ...
      flags: [], s: { hp: 1.31, atk: 0.4, mag: 0.74, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    automaton_1: {
      ...
      flags: [], s: { hp: 1.16, def: 1.2, agi: 0.95, atk: 0.99, mag: 0.99 }, eva: 5,
    ...
    automaton_2: {
      ...
      flags: [], s: { def: 1.15, hp: 1.18, atk: 0.9, mag: 0.9 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    automaton_3: {
      ...
      flags: [], s: { mag: 0.76, def: 1.1, mdef: 1.2, atk: 0.61, hp: 1.26 }, eva: 5,
    ...
    automaton_4: {
      ...
      flags: [], s: { hp: 1.73, atk: 0.77, def: 1.25, mag: 0.67 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_1: {
      ...
      flags: [], s: { hp: 1.32, def: 1.35, agi: 0.8, atk: 0.99, mag: 0.99 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_2: {
      ...
      flags: [], s: { hp: 1.42, def: 1.4, agi: 0.8, atk: 0.9, mag: 0.9 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_3: {
      ...
      flags: [], s: { hp: 1.58, atk: 0.68, def: 1.35, mag: 0.61 }, eva: 5,
      elem: { water: 1.25, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_4: {
      ...
      flags: [], s: { hp: 1.79, atk: 0.8, def: 1.35, mag: 0.67 }, eva: 5,
    ...
    wyvern_1: {
      ...
      flags: ['flying'], s: { hp: 1.21, atk: 1.08, agi: 1.1, mag: 0.99 }, eva: 12,
    ...
    wyvern_2: {
      ...
      flags: ['flying'], s: { hp: 1.4, atk: 0.98, agi: 1.15, mag: 0.85 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
    ...
    wyvern_3: {
      ...
      flags: ['flying'], s: { hp: 1.73, atk: 0.61, mag: 0.58, agi: 1.15 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
