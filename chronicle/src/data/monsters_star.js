...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    eyeball_1: {
      ...
      flags: [], s: { hp: 1.47, mag: 0.91, agi: 1.1, atk: 0.83 }, eva: 5,
    ...
    eyeball_2: {
      ...
      flags: [], s: { hp: 1.9, mag: 2, agi: 1.1, atk: 1.74 }, eva: 5,
      elem: { light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_3: {
      ...
      flags: [], s: { hp: 1.2, mag: 0.5, agi: 1.1, atk: 0.5 }, eva: 5,
    ...
    eyeball_4: {
      ...
      flags: [], s: { mag: 0.5, mdef: 1.2, agi: 1.1, hp: 1.96, atk: 0.5 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_5: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.5, mdef: 1.25, agi: 1.05, atk: 0.5 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    darkmage_1: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.5, mag: 0.85, def: 0.85, mdef: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    darkmage_2: {
      ...
      flags: [], s: { hp: 1.88, atk: 0.5, mag: 0.5, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    darkmage_3: {
      ...
      flags: [], s: { hp: 1.91, atk: 0.5, mag: 0.5, def: 0.85, mdef: 1.3, agi: 1.15 }, eva: 5,
    ...
    darkmage_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.5, mag: 0.5, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    automaton_1: {
      ...
      flags: [], s: { hp: 1.07, def: 1.2, agi: 0.95, atk: 0.98, mag: 0.98 }, eva: 5,
    ...
    automaton_2: {
      ...
      flags: [], s: { def: 1.15, hp: 1.32, atk: 0.84, mag: 0.84 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    automaton_3: {
      ...
      flags: [], s: { mag: 0.64, def: 1.1, mdef: 1.2, hp: 1.52, atk: 0.51 }, eva: 5,
    ...
    automaton_4: {
      ...
      flags: [], s: { hp: 1.4, def: 1.25, mag: 0.69, atk: 0.8 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_1: {
      ...
      flags: [], s: { def: 1.35, agi: 0.8, atk: 1.47, mag: 1.47, hp: 1.05 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_2: {
      ...
      flags: [], s: { hp: 1.09, def: 1.4, agi: 0.8, atk: 1.01, mag: 1.01 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_3: {
      ...
      flags: [], s: { hp: 1.42, atk: 0.71, def: 1.35, mag: 0.63 }, eva: 5,
      elem: { water: 1.25, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_4: {
      ...
      flags: [], s: { hp: 1.6, atk: 0.67, def: 1.35, mag: 0.56 }, eva: 5,
    ...
    wyvern_1: {
      ...
      flags: ['flying'], s: { hp: 1.15, atk: 0.77, agi: 1.1, mag: 0.7 }, eva: 12,
    ...
    wyvern_2: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.56, agi: 1.15, mag: 0.5 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
    ...
    wyvern_3: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.5, mag: 0.5, agi: 1.15 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
