...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    eyeball_1: {
      ...
      flags: [], s: { hp: 1.25, mag: 1.1, agi: 1.1 }, eva: 5,
    ...
    eyeball_2: {
      ...
      flags: [], s: { hp: 1.66, mag: 1.15, agi: 1.1 }, eva: 5,
      elem: { light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_3: {
      ...
      flags: [], s: { hp: 1.28, mag: 0.31, agi: 1.1, atk: 0.31 }, eva: 5,
    ...
    eyeball_4: {
      ...
      flags: [], s: { mag: 0.38, mdef: 1.2, agi: 1.1, hp: 2.02, atk: 0.38 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_5: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.32, mdef: 1.25, agi: 1.05, atk: 0.32 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    darkmage_1: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.58, mag: 0.98, def: 0.85, mdef: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    darkmage_2: {
      ...
      flags: [], s: { hp: 1.66, atk: 0.48, mag: 0.48, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    darkmage_3: {
      ...
      flags: [], s: { hp: 2.44, atk: 0.48, mag: 0.48, def: 0.85, mdef: 1.3, agi: 1.15 }, eva: 5,
    ...
    darkmage_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.51, mag: 0.51, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    automaton_1: {
      ...
      flags: [], s: { hp: 1.07, def: 1.2, agi: 0.95 }, eva: 5,
    ...
    automaton_2: {
      ...
      flags: [], s: { def: 1.15, hp: 1.32, atk: 0.95, mag: 0.95 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    automaton_3: {
      ...
      flags: [], s: { mag: 0.77, def: 1.1, mdef: 1.2, hp: 1.48, atk: 0.62 }, eva: 5,
    ...
    automaton_4: {
      ...
      flags: [], s: { hp: 1.41, def: 1.25, mag: 0.77, atk: 0.9 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_1: {
      ...
      flags: [], s: { def: 1.35, agi: 0.8, hp: 1.07 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_2: {
      ...
      flags: [], s: { hp: 0.93, def: 1.4, agi: 0.8 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_3: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.84, def: 1.35, mag: 0.74 }, eva: 5,
      elem: { water: 1.25, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_4: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.81, def: 1.35, mag: 0.67 }, eva: 5,
    ...
    wyvern_1: {
      ...
      flags: ['flying'], s: { hp: 1.14, atk: 0.84, agi: 1.1, mag: 0.78 }, eva: 12,
    ...
    wyvern_2: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.62, agi: 1.15, mag: 0.56 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
    ...
    wyvern_3: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.46, mag: 0.46, agi: 1.15 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
