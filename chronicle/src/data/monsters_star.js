...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    eyeball_2: {
      ...
      flags: [], s: { hp: 1.73, mag: 1.15, agi: 1.1 }, eva: 5,
      elem: { light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_3: {
      ...
      flags: [], s: { hp: 1.27, mag: 0.3, agi: 1.1, atk: 0.3 }, eva: 5,
    ...
    eyeball_4: {
      ...
      flags: [], s: { mag: 0.43, mdef: 1.2, agi: 1.1, hp: 1.95, atk: 0.43 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_5: {
      ...
      flags: [], s: { hp: 2.5, mag: 0.31, mdef: 1.25, agi: 1.05, atk: 0.31 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    darkmage_1: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.58, mag: 0.97, def: 0.85, mdef: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    darkmage_2: {
      ...
      flags: [], s: { hp: 1.81, atk: 0.53, mag: 0.53, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    darkmage_3: {
      ...
      flags: [], s: { hp: 2.28, atk: 0.44, mag: 0.44, def: 0.85, mdef: 1.3, agi: 1.15 }, eva: 5,
    ...
    darkmage_4: {
      ...
      flags: [], s: { hp: 2.5, atk: 0.48, mag: 0.48, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    automaton_1: {
      ...
      flags: [], s: { def: 1.2, agi: 0.95, hp: 1.05 }, eva: 5,
    ...
    automaton_2: {
      ...
      flags: [], s: { def: 1.15, hp: 1.27, atk: 0.84, mag: 0.84 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    automaton_3: {
      ...
      flags: [], s: { mag: 0.71, def: 1.1, mdef: 1.2, hp: 1.45, atk: 0.57 }, eva: 5,
    ...
    automaton_4: {
      ...
      flags: [], s: { hp: 1.49, def: 1.25, mag: 0.73, atk: 0.84 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_1: {
      ...
      flags: [], s: { def: 1.35, agi: 0.8, hp: 0.99 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_2: {
      ...
      flags: [], s: { hp: 0.96, def: 1.4, agi: 0.8 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_3: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.77, def: 1.35, mag: 0.68 }, eva: 5,
      elem: { water: 1.25, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_4: {
      ...
      flags: [], s: { hp: 1.3, atk: 0.79, def: 1.35, mag: 0.65 }, eva: 5,
    ...
    wyvern_1: {
      ...
      flags: ['flying'], s: { hp: 1.35, atk: 1.1, agi: 1.1 }, eva: 12,
    ...
    wyvern_2: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.69, agi: 1.15, mag: 0.62 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
    ...
    wyvern_3: {
      ...
      flags: ['flying'], s: { hp: 2.5, atk: 0.51, mag: 0.51, agi: 1.15 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
