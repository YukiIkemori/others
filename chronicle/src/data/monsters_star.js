...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    eyeball_1: {
      ...
      flags: [], s: { hp: 0.9, mag: 1.1, agi: 1.1 }, eva: 5,
    ...
    eyeball_2: {
      ...
      flags: [], s: { hp: 0.9, mag: 1.15, agi: 1.1 }, eva: 5,
      elem: { light: 1.5, dark: 0.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_3: {
      ...
      flags: [], s: { hp: 0.95, mag: 1.2, agi: 1.1 }, eva: 5,
    ...
    eyeball_4: {
      ...
      flags: [], s: { mag: 0.92, mdef: 1.2, agi: 1.1, atk: 0.74 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    eyeball_5: {
      ...
      flags: [], s: { hp: 1.3, mag: 0.62, mdef: 1.25, agi: 1.05, atk: 0.5 }, eva: 5,
      elem: { light: 0.25, dark: 1.5 }, phys: {}, statusRes: { death: 0.8 },
    ...
    darkmage_1: {
      ...
      flags: [], s: { hp: 0.9, atk: 0.75, mag: 1.3, def: 0.85, mdef: 1.3 }, eva: 5,
      elem: {}, phys: {}, statusRes: {},
    ...
    darkmage_2: {
      ...
      flags: [], s: { hp: 0.9, atk: 0.75, mag: 1.35, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    darkmage_3: {
      ...
      flags: [], s: { hp: 0.9, atk: 0.75, mag: 1.35, def: 0.85, mdef: 1.3, agi: 1.15 }, eva: 5,
    ...
    darkmage_4: {
      ...
      flags: [], s: { hp: 0.95, atk: 0.6, mag: 1.11, def: 0.85, mdef: 1.3 }, eva: 5,
    ...
    automaton_1: {
      ...
      flags: [], s: { hp: 1.05, def: 1.2, agi: 0.95 }, eva: 5,
    ...
    automaton_3: {
      ...
      flags: [], s: { mag: 0.95, def: 1.1, mdef: 1.2, atk: 0.76 }, eva: 5,
    ...
    automaton_4: {
      ...
      flags: [], s: { hp: 1.25, atk: 1.15, def: 1.25 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_1: {
      ...
      flags: [], s: { hp: 1.2, def: 1.35, agi: 0.8 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_2: {
      ...
      flags: [], s: { hp: 1.2, def: 1.4, agi: 0.8 }, eva: 5,
      elem: { water: 1.5, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_3: {
      ...
      flags: [], s: { hp: 1.25, atk: 0.84, def: 1.35, mag: 0.76 }, eva: 5,
      elem: { water: 1.25, wind: 0.75, light: 0.25, dark: 1.5 }, phys: { slash: 0.75, blunt: 1.5, pierce: 0.75 }, statusRes: { poison: 1, sleep: 1, confuse: 1, death: 1 },
    ...
    armor_4: {
      ...
      flags: [], s: { hp: 1.3, atk: 1.2, def: 1.35 }, eva: 5,
    ...
    wyvern_1: {
      ...
      flags: ['flying'], s: { hp: 1.1, atk: 1.1, agi: 1.1 }, eva: 12,
    ...
    wyvern_2: {
      ...
      flags: ['flying'], s: { hp: 1.15, atk: 1.15, agi: 1.15 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
    ...
    wyvern_3: {
      ...
      flags: ['flying'], s: { hp: 1.25, atk: 0.91, mag: 0.87, agi: 1.15 }, eva: 12,
      elem: { fire: 1.5, water: 0.75, wind: 0.25, earth: 0.5, light: 0.75, dark: 0.75 }, phys: { slash: 0.75, pierce: 1.25 }, statusRes: { death: 1, sleep: 0.5, confuse: 0.5 },
