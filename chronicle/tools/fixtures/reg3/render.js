// R3 (reg3) fixture: whole-map renderer for visual checks (browser only).
//   RPG.r3ShowMap(mapId, {flags:[..], tier, scale:2, pad:2, crop:{x,y,w,h}, grid:false, marks:true})
...
// Never overrides anything that exists; it only adds RPG.r3ShowMap.
(function (R) {
  'use strict';
  const TS = 16;
