// R8 reg8 fixture (copied from the prologue fixture): whole-map renderer for visual checks (browser only).
//   RPG.reg8ShowMap(mapId, {flags:[..], tier, scale:2, pad:2, crop:{x,y,w,h}, grid:false, marks:true})
...
// Never overrides anything that exists; it only adds RPG.reg8ShowMap.
(function (R) {
  'use strict';
  const TS = 16;
