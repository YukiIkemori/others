// OB (oblivion) fixture (adapted from the prologue renderer): whole-map renderer for visual checks (browser only).
//   RPG.obShowMap(mapId, {flags:[..], tier, scale:2, pad:2, crop:{x,y,w,h}, grid:false, marks:true})
...
// Never overrides anything that exists; it only adds RPG.obShowMap.
(function (R) {
  'use strict';
  const TS = 16;
