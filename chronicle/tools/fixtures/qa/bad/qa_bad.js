...
(function (R) {
  ...
  DB.actions.t_sword_qa_from = { kind: 'tech', wtype: 'sword', name: 'けんさの二の太刀', desc: '検査用の技。', wp: 3, target: 'enemy', reach: false, effects: [{ type: 'damage', power: 1 }], rank: 3, glim: { lv: 3, from: ['t_axe_qa_nope'] } };
