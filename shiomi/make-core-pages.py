  ...
  <section class="band">
    <div class="container">
      ...
      <dl class="facts-strip">
        ...
        <div><dt>チェックイン</dt><dd><span class="nowrap"><span class="figure figure--small">15:00</span> /</span> <span class="nowrap">チェックアウト 10:00</span></dd></div>
...
{overlap("guests-engawa", "3x2", S_OVER, "過ごし方", "stay-h",
   ["何をするでもなく、縁側に座って庭を眺めている方が多いです。ピアノを弾く方、井戸を汲んでみる方、五右衛門風呂を自分で焚く方もいます。",
...
{bp.side("設備・アメニティ", deflist([
  ("お風呂・洗面", "五右衛門風呂／シャワールーム（リンスインシャンプー、ボディシャンプー）／洗面台2台（ドライヤー1台）"),
