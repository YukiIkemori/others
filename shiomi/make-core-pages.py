...
about = [
 ...
 bp.page_head("汐見の家について", "瀬戸内海に浮かぶ佐島の、伝統工法の古民家です。"),
 f'''
...
{bp.side("この家のこと", f"""          <div class="prose">
  ...
  <section class="band">
    <div class="container">
      ...
      <dl class="facts-strip facts-strip--3col">
...
{overlap("guests-engawa", "3x2", S_OVER, "過ごし方", "stay-h",
   ["何をするでもなく、縁側に座って庭を眺めている方が多いです。ピアノを弾く方、井戸を汲んでみる方、五右衛門風呂を自分で焚く方（前日までにご相談ください）もいます。縁側の引き戸には鍵がありません。猫も出入りしています。",
...
{collage([
  ("goemon-bath", "2x3", "五右衛門風呂",
   ["薪で焚きます。井戸の水を引いて沸かします。上がり湯には上水を引きました。焚きつけから湯加減まで、やりたい方にはお任せします。",
    "準備に時間がかかるため、ご利用は前日までのご相談をお願いしています。日によってはお受けできないこともありますので、ご予約のときにお申し付けください。"]),
  ("well-pump", "3x2", "井戸",
   ["庭にあります。手押しポンプ、またはバケツで汲みます。五右衛門風呂に使う水はここから。水質検査では飲用不適合でしたので、そこだけご注意ください。"]),
  ("prayer-room", "3x2", "簡易イスラム礼拝室",
   ["ムスリムフレンドリーな宿でありたいと思っています。ご要望に応じて、男女別の礼拝室に設えます。遠慮なくお申し出ください。",
    "コーラン（アラビア語版、英語対訳版）、キブラシール、カーペットが2セットあります。お清めはシャワールームまたは洗面台をお使いください。お食事についても事前にご相談いただけます。"]),
...
{bp.side("設備・アメニティ", deflist([
  ...
  ("貸出", "タオル（バスタオル・フェイスタオル 各100円）／貸自転車（ママチャリ1台。事前にご連絡ください）"),
  ("通信", "フリーWi-Fi"),
...
{bp.side("シェアごはん", """          <div class="prose">
            ...
            <p>料理が苦手でも大丈夫です。できることを手伝ってもらいます。料理上手な方は、ぜひ「今日は板長やるよ」とご連絡ください。</p>
            <p>遅くなる方は持ち寄りも歓迎です。弓削島ラーメン党のお好み焼きの宅配もおすすめ。ご連絡いただければこちらで注文します。</p>
            <p>島の方や移住者が差し入れを持って来て宴会になることもあれば、結局ひとりのこともあります。</p>
          </div>""")}
      <dl class="facts-strip">
...
{bp.side("外で食べる", """          <div class="prose">
  ...
  <section class="band">
    <div class="container">
      ...
      <dl class="facts-strip">
        <div><dt>ビール</dt><dd><span class="nowrap">350ml缶 <span class="figure figure--small">300</span>円</span><small>主にアサヒスーパードライ</small></dd></div>
...
{overlap("lane-sign", "3x2", S_OVER, "サイクリングで来る方へ", "cycle-h",
  ["しまなみ海道を走る方、ライダーの方も歓迎です。宿にもママチャリが1台あります。ご利用の場合は事前にご連絡ください。",
  ...
  <section class="band">
    <div class="container">
      ...
      <dl class="facts-strip">
        ...
        <div><dt>車</dt><dd>港のそばの駐車場に停められます</dd></div>
      </dl>
      <div class="note">
