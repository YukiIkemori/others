...
// (review tool for the サルバ redesign; loads src/ directly, no build needed).
//
...
const OUT = path.resolve(opt('out', '/tmp/claude-0/salva/render'));
const MAPS = opt('maps', 'salva_town,salva_house').split(',');
