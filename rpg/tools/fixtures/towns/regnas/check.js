#!/usr/bin/env node
// Decor-aware checks for the レグナス maps (castle, town, house interiors):
...
const MAPS = ['regnas_castle', 'regnas_town', 'regnas_house_yuki', 'regnas_house_elder', 'regnas_storehouse'];
const errors = [], warns = [];
...
console.log(`\nregnas check: ${errors.length} error(s), ${warns.length} warning(s)`);
