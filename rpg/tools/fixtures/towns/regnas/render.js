...
// (review tool for the レグナス redesign; loads src/ directly, no build needed).
//
...
const OUT = path.resolve(opt('out', '/tmp/claude-0/regnas/render'));
const MAPS = opt('maps', 'regnas_castle,regnas_town,regnas_house_yuki,regnas_house_elder,regnas_storehouse').split(',');
