...
// (review tool for the アルカナ redesign; loads src/ directly, no build needed).
//
//   node tools/fixtures/towns/arcana/render.js --maps arcana_city [--out DIR]
...
const OUT = path.resolve(opt('out', '/tmp/claude-0/arcana/render'));
const MAPS = opt('maps', 'arcana_city,arcana_house_metem').split(',');
