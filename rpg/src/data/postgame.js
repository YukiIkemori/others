...
(function (R) {
  ...
  Object.assign(R.DB.abilities, {
    ...
    en_pg_lord_void:   act('虚無の吐息', 'enemies', [breath(240, 'dark')], 'breath_dark', '{user}はすべてを呑み込む虚無の吐息を吐いた！'),
    ...
    en_pg_lord_roar:   act('終焉の咆哮', 'enemies', [magic(120, 0.7)], 'explosion3', '{user}は世界の終わりを告げる咆哮を上げた！'),
  ...
  Object.assign(R.DB.monsters, {
    ...
    abyss_lord: {
      ...
      hp: 11000, mp: 0, atk: 300, def: 180, agi: 110, mag: 260, mdef: 110, eva: 2,
