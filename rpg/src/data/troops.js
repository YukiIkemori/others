...
(function (R) {
  ...
  Object.assign(R.DB.monsters, {
    ...
    sea_serpent: boss({
      ...
      hp: 1500, mp: 0, atk: 106, def: 34, agi: 30, mag: 48, mdef: 18, exp: 1100, gold: 1100, jp: 180,
      fam: ['sea'],
    ...
    frost_giant: boss({
      ...
      hp: 1900, mp: 0, atk: 186, def: 52, agi: 30, mag: 64, mdef: 26, exp: 2800, gold: 2400, jp: 300,
      fam: ['frost', 'beast'],
    ...
    flame_lord: boss({
      ...
      hp: 1750, mp: 120, atk: 172, def: 60, agi: 44, mag: 104, mdef: 32, exp: 3700, gold: 3200, jp: 360,
      fam: ['flame'],
    ...
    star_guardian: boss({
      ...
      hp: 2700, mp: 200, atk: 160, def: 66, agi: 60, mag: 120, mdef: 44, exp: 4700, gold: 4000, jp: 420,
    ...
    dark_general: boss({
      ...
      hp: 4400, mp: 0, atk: 210, def: 80, agi: 62, mag: 110, mdef: 48, exp: 6000, gold: 5000, jp: 480,
    ...
    lich_general: boss({
      ...
      hp: 5600, mp: 500, atk: 150, def: 72, agi: 70, mag: 250, mdef: 70, exp: 6900, gold: 5500, jp: 520,
    ...
    demon_king: boss({
      ...
      hp: 6600, mp: 0, atk: 228, def: 88, agi: 72, mag: 200, mdef: 64, exp: 0, gold: 0, jp: 0,
      fam: ['demon'], elem: { dark: -1 },
    ...
    demon_king2: boss({
      ...
      hp: 6000, mp: 0, atk: 182, def: 92, agi: 76, mag: 145, mdef: 70, exp: 0, gold: 0, jp: 0,
      fam: ['demon'], elem: { dark: -1 },
