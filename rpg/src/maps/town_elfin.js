...
(function (R) {
  ...
  R.DB.maps.elfin_village = {
    ...
    rows: [
      ...
      'TTTTTTTTTTTTTTT,f,,?,,,f,TT###########TT',
      'TTTRRRRRRRRRRT,f~~~~~~~~f,T###########TT',
      'TTTRRRRRRRRRRTf~~~~~~~~~~fT#___YOY___#TT',
      ...
      'TTB_u____N___B,,:,,~~,,,,,BccccccccccBTT',
      'TTB_Ic_______B,,:,,~~,W,,,B__________BTT',
  ...
  // ================================================================ elder's house
  // study (books, globe, desk) · hearth · bedroom · kitchen and dining corner
  ...
  // ================================================================ weaver's house
  // workroom (cloth on the walls, work table, bolts of cloth) · bed nook · kitchen
